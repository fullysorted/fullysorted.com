...
export const seedF1005thGen = {
 ...
 "engines": [
  "240 cu in (3,933 cc) Thriftpower inline six, 150 hp gross; VIN code A",
  "300 cu in (4,916 cc) inline six, 4.00 in bore by 3.98 in stroke, 170 hp gross at 3,800 rpm, 283 lb-ft at 1,600 rpm; VIN code B",
  "352 cu in (5,769 cc) FE V8, 208 hp gross, 1967 only; VIN code Y that year",
  "360 cu in (5,899 cc) FE V8, 215 hp gross from 1968; 196 hp net for 1972; VIN code Y from 1968",
  "390 cu in (6,391 cc) FE V8, 255 hp gross from 1968; 201 hp net for 1972 and 2WD only that year; VIN code H",
  "302 cu in (4,942 cc) Windsor V8, 205 hp gross from 1969; 154 hp net for 1972; VIN code G",
  "A 170 cu in six at 105 hp is listed by some references but absent from the 1967 VIN engine-code table (see claims)"
 ],
 ...
 "notableTrims": [
  {
   ...
   "note": "The working specification: rubber mat, painted metal door panels, vinyl bench, aluminum scuff plates. Most of these trucks left the plant close to this, and an unmolested one is now harder to find than a Ranger, because nobody thought to keep them."
  },
  {
   "name": "Ranger",
   "note": "The upper trim at launch: thicker seat foam, color-keyed carpet, upholstered door inserts, extra brightwork, its own hubcaps. For 1968 and 1969 only a Ranger emblem sat in the grille center — a one-glance identifier, easily transplanted, worth checking against the trim code."
  },
  {
   "name": "Sport Custom",
   "note": "The middle rung added when the ladder was reorganized at the turn of the decade: heavier foam, two-tone vinyl, color-keyed mats, better instrumentation, without the Ranger's carpet and wood-tone. Sources place its arrival at 1969 or 1970."
  },
  {
   "name": "Ranger XLT",
   "note": "The top of the range and the point of the generation: full carpet, pleated cloth and vinyl, wood-tone dash and tailgate appliqué, heavy door padding, extra insulation, cargo lamp, aluminum moldings, 12-inch mirror. Correct XLT trim is the hardest thing to source on a restoration."
  },
  {
 ...
 "specs": {
  ...
  "power": "Gross: 240 six 150 hp, 300 six 170 hp at 3,800 rpm, 352 FE 208 hp, 360 FE 215 hp, 390 FE 255 hp, 302 Windsor 205 hp. Ford moved to SAE net for 1972, at which point the 302 is quoted at 154 hp, the 360 at 196 hp and the 390 at 201 hp",
  ...
  "weight": "A 1971 F-100 short-bed is quoted at 3,615 lb curb by one specialist reference. No factory weight table was retrieved, and the figure varies widely with cab, bed, drivetrain and engine",
 ...
 "sources": [
  {
   ...
   "reliability": "medium",
   "notes": "Trim ladder as Base/Custom Cab/Ranger for 1967-69 and Custom/Sport Custom/Ranger XLT with the XLT placed at 1970; Canadian Explorer Special; engine list including a 170 cu in six at 105 hp; wheelbases for all three series; Styleside and Flareside bed lengths."
  },
  {
   ...
   "reliability": "medium",
   "notes": "Year-by-year grille identification; the 1968-1969-only grille-center Ranger emblem; 1967 cab gaining three inches of room; trim content for both ladders; gross and net horsepower for the 240, 300, 352, 360, 390 and 302; the Styleside/Flareside crease; power brakes reaching 4WD for 1972."
  },
  {
   "ref": "ttac-fifth-gen",
  ...
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "high",
   "notes": "1967 series codes F10/F11/F25/F26/F35 and the engine-code table: A = 240 six at 150 hp, B = 300 six at 170 hp, Y = 352 FE at 208 hp, with low-compression variants 1, 2 and 8. No 170 cu in six appears. Plant letters and the 81/84/85 body codes."
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "high",
   "notes": "1972 series codes F10/F11/F25/F26/F35/F37 separating 2WD from 4WD; engine codes A = 240, B = 300, G = 302, Y = 360, H = 390, the 390 noted 2WD only and no 351 code at all; net ratings of 154, 196 and 201 hp; body code third digit 3 = Flareside, 4 = Styleside; trim codes identifying Ranger XLT and Explorer."
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "Twin I-Beam introduced 1965 on F-100 to F-350; two offset overlapping chrome-moly forgings of roughly 36 in; forged steel radius arms taking braking and fore-aft loads so lighter coil springs could be used; roughly one degree of camber change per inch of travel, with tire wear when ride height is altered; alignment difficulty."
  },
  {
  ...
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "low",
   "notes": "The source dating the Ranger XLT to 1971 as a new tier above an existing Ranger, on a four-level 1971 ladder. Also the only retrieved source quoting a curb weight, 3,615 lb for a 1971 short-bed, and a 1971 F-100 production figure of 190,347 that does not reconcile with the reference-book tables."
  },
  {
  ...
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "The lowered-2WD side of the market: Twin I-Beam trucks have very little caster and so wander on rough roads, are hard on tires and shock absorbers, have leak-prone steering boxes and are difficult to lower correctly; describes the Mustang II-style replacement subframe with rack-and-pinion steering, dropped spindles and 11.75 in discs."
  },
  {
  ...
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "300 six specification: 4.00 in bore by 3.98 in stroke, 8.9:1 compression for 1965-1972, 170 hp at 3,800 rpm and 283 lb-ft at 1,600 rpm gross, falling to 101 hp net for 1973-74; derived from the 240 by lengthening the stroke on an identical bore; in F-Series production until 1996."
  }
 ],
 "claims": [
  {
  ...
  {
   "section": "specs",
   "claimText": "Twin I-Beam's known drawbacks are approximately one degree of camber change per inch of travel, very little caster, difficult alignment, heavy front tire wear and short shock absorber life, with period steering boxes described as leak-prone.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "macs-twin-i-beam",
  ...
  {
   "section": "specs",
   "claimText": "The engine range comprised 240 and 300 cubic-inch inline sixes throughout, the 352 FE V8 for 1967 only, the 360 and 390 FE V8s from 1968 and the 302 Windsor V8 from 1969, with gross ratings of 150, 170, 208, 215, 255 and 205 hp respectively; Ford moved to SAE net for 1972, at which point the 302 is rated 154 hp, the 360 196 hp and the 390 201 hp, the 390 listed for two-wheel-drive trucks only.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
  ...
  {
   "section": "specs",
   "claimText": "The 300 cubic-inch six was derived from the 240 by lengthening the stroke on an identical 4.00 inch bore, measures 4.00 by 3.98 inches, ran 8.9:1 compression in this period and was rated at 170 hp at 3,800 rpm and 283 lb-ft at 1,600 rpm gross.",
   "confidence": "medium",
   "status": "verified",
   "sourceRefs": [
    "f150hub-300-six",
  ...
  },
  {
   ...
   "conflictNote": "Wikipedia lists a 170 cu in six at 105 hp for 1967-1972 and Classic Industries lists the same engine for 1967 only. FORDification's 1967 VIN engine-code table gives only A, B and Y for the 240, 300 and 352 plus their low-compression variants, and contains no 170 code at all. Not resolved by any source consulted here, so the engine is listed with that caveat attached rather than asserted."
  },
  {
   "section": "history",
   "claimText": "The trim ladder ran Base, Custom Cab and Ranger at launch and was reorganized at the turn of the decade into Custom, Sport Custom, Ranger and Ranger XLT, but the model years in which the Sport Custom and the Ranger XLT first appeared are given differently by different sources.",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": [
    "wikipedia-f-series-5",
