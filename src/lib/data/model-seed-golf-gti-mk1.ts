...
export const seedGolfGtiMk1 = {
 ...
 "specs": {
  ...
  "suspension": "MacPherson struts front, torsion-beam rear axle; ride height lowered 0.39 in (10 mm) front and 0.79 in (20 mm) rear against the standard Golf, with stiffer anti-roll bars",
 ...
 "claims": [
  ...
  {
   "section": "production",
   "claimText": "Production was originally authorized as a homologation run of 5,000 cars, the number then required for Group 1 production touring car eligibility.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "wikipedia-golf-mk1",
