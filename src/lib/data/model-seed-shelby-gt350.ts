...
export const seedShelbyGt350 = {
 ...
 "engines": [
  ...
  "4,727 cc 289 V8 with optional Paxton centrifugal supercharger, 1966-1967, quoted at roughly 380-400 hp",
  "4,942 cc (302 cu in) Ford Windsor V8, hydraulic tappets, Cobra alloy inlet, Holley 600 cfm, 250 hp and 310 lb-ft (1968)",
  "5,752 cc (351 cu in) Ford Windsor V8, Cobra alloy inlet, 290 hp at 4,800 rpm and 385 lb-ft at 3,400 rpm (1969, carried into the re-serialled 1970 cars)"
 ],
 ...
 "notableTrims": [
  {
   ...
   "note": "The homologation car proper: Wimbledon White only, Guardsman Blue rocker stripes, an aluminum-case T-10 four-speed as the only gearbox, Detroit Locker axle, side-exit exhaust, no rear seat. Early cars carried the battery in the trunk until fume complaints ended it mid-year."
  },
  {
  ...
  },
  {
   ...
   "note": "Around a thousand cars supplied to Hertz for the Rent-a-Racer program, mostly Raven Black with gold stripes. The earliest had four-speed manuals, most of the rest automatics. Renters raced them and returned them short of parts, and they trade well below a private-sale 1966 car."
  },
  {
   "name": "GT350 with Paxton supercharger (1966-1967)",
   "note": "Centrifugal blower quoted at roughly 380-400 hp, fitted by dealers as well as the factory; eleven supercharged cars are cited for 1966. Documented period installations carry a premium, later retro-fits do not."
  },
  {
   "name": "GT350 (1967)",
   "note": "First year of Ford's design involvement and of extensive glassfiber: new nose, hood, spoilered trunk lid and brake ducts on the same 306 hp 289. The first year the GT350 was outsold by its big-block sibling, and the last built in California."
  },
  {
  ...
  },
  {
   ...
   "note": "Not built as 1970s at all: unsold 1969 stock re-serialled under FBI supervision, the leading VIN digit changed from 9 to 0, with new plates, a chin spoiler, two black hood stripes and emissions work. Paperwork matters more here than anywhere else in the run."
  }
 ],
 "specs": {
  "layout": "Front V8, rear-wheel drive; two-seat or 2+2 cabin depending on year",
  "chassis": "Ford Mustang unitary steel body-frame, modified: 1965-66 cars gained lowered upper A-arm pivots, an export brace and a Monte Carlo bar; later cars carried more glassfiber over the same structure",
  "engine": "289 cu in K-code Windsor V8 (1965-67); 302 (1968); 351 Windsor (1969-70)",
  "power": "306 hp at 6,000 rpm (1965-67); 250 hp (1968); 290 hp at 4,800 rpm (1969-70) - period gross SAE ratings, manufacturer claims rather than measured figures",
  "torque": "329 lb-ft at 4,200 rpm (1965-67); 310 lb-ft (1968); 385 lb-ft at 3,400 rpm (1969-70)",
  "transmission": "Aluminum-case Borg-Warner T-10 four-speed only for 1965; three-speed automatic optional from 1966 (C4 on the Hertz cars, FMX by 1969)",
  ...
  "exhaust": "Side-exit glasspack mufflers for 1965; conventional rear-exit dual system from 1966",
  ...
  "wheels_tires": "15-inch painted steel or Cragar/Shelby magnesium-center rims on Goodyear Blue Dot tires for 1965; Magnum 500 and ten-spoke cast-aluminum options followed",
  "weight": "About 2,790-2,800 lb for a 1965 car; 3,146 lb curb quoted for the 1968, the gain reflecting bodywork, a rear seat and trim",
  ...
  "bodywork": "Steel shell with a glassfiber hood from 1965; by 1967-68 the nose, hood, front wings, scoops and trunk lid were glassfiber, molded at Shelby American and then A.O. Smith"
 },
 "summary": "The Shelby GT350 began as a homologation exercise rather than a marketing one. Lee Iacocca wanted a Mustang with a competition record, and from August 1964 Carroll Shelby's Venice premises took incomplete Wimbledon White fastbacks from Ford's San Jose plant and turned them into cars the SCCA would accept in B-Production. The 1965 run of 562 was barely civilized: a 306 hp 289, a four-speed and nothing else, side-exit exhaust, relocated suspension pick-ups, no rear seat. Everything after that was a retreat from the brief. For 1966 came colors, an automatic option and roughly a thousand black-and-gold Hertz rental cars; for 1967, glassfiber styling and Ford's own designers; for 1968, assembly by A.O. Smith in Ionia, Michigan and a 250 hp 302 in place of the K-code 289; and by 1969 a 351-powered cruiser with imitation teak on the dash. There was no 1970 production at all - unsold 1969 cars were re-serialled as 1970 models under FBI supervision. The value divide follows that story almost exactly.",
 "history": "## Homologation, Not Marketing\nFord had a Mustang that sold in enormous numbers and won nothing. Lee Iacocca's remedy was to ask Carroll Shelby whether the car could be given a competition image, and the answer took the shape of an SCCA B-Production homologation program approved in August 1964. In late December Ford's San Jose plant shipped incomplete Wimbledon White K-code fastbacks to Shelby American's Venice shop, where they were rebuilt: lowered upper A-arm pivots, an export brace and Monte Carlo bar, over-ride traction bars, a Detroit Locker axle, glasspack side exhausts, a glassfiber hood, and the rear seat removed so the car could be registered as a two-seater. The engine gained an aluminum Cobra inlet, a Holley 715 and Tri-Y headers for a quoted 306 hp. The class rules, not the customer, dictated the specification.\n\n## The R-Models and What They Won\nAlongside the street cars Shelby built a competition version, the R-model: caged, stripped, plexiglass-glazed, with the interior and most of the trim simply absent. Sources put the number at 34, 35 or 36. What is not in dispute is the result - the GT350 took the B-Production national championship three years running, which was precisely what Ford had paid for, and the R-models have since detached from the street-car market entirely.\n\n## Carryovers, Colors and a Fleet of Rental Racers\nFor 1966 Shelby American bought 252 leftover 1965 K-code Mustangs to keep the line running through Ford's San Jose retooling shutdown. Those carryover cars, serials 6S001 to 6S252, wear 1966 bodywork over 1965 mechanicals and are the most sought-after of the year. The rest of 1966 saw the car softened: four extra colors, a fold-down rear seat, an automatic option, quarter windows in place of the extraction louvres, rear-exit exhaust. The defining event was Peyton Cramer's proposal to Hertz, which became an order of around a thousand GT350H rental cars, mostly Raven Black with gold stripes. Renters treated them as advertised, raced them at weekends and returned them with components missing.\n\n## Ford Takes the Pen\nThe 1967 car was the first designed with Ford's involvement rather than around a rulebook. A glassfiber nose, hood, spoilered trunk lid and functional brake ducts lengthened and softened it; the 289 stayed at 306 hp but headers and straight-through mufflers became options. It was outsold nearly two to one by the new big-block GT500. By mid-1967 Shelby American's quality and capacity problems, plus the loss of its airport lease, had persuaded Ford to move the work: in August 1967 it went to A.O. Smith at Ionia, Michigan, where matched-metal molding finally produced glassfiber panels that fitted. The 1968 cars came part-built from Ford's Metuchen, New Jersey plant, wore Cobra badging, offered a convertible for the first time, and swapped the K-code 289 for a hydraulic-cammed 302 rated at 250 hp.\n\n## The End, and the Cars That Were Not Built\nBy 1969 the GT350 had a 351 Windsor, a three-scoop hood, imitation teak trim and a tape deck, and Shelby's involvement had thinned to a name; he asked Ford to end the agreement in the summer of 1969. That left unsold cars in stock and no 1970 model. Ford's answer was to re-serial them: the leading VIN digit changed from 9 to 0, new door and windshield plates, revised distributors, a chin spoiler and two black hood stripes - carried out, every source agrees, under FBI supervision. How many cars were treated this way is not agreed.",
 ...
 "sources": [
  ...
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "The Hertz program: Peyton Cramer's September 1965 approach, first 28 cars delivered February 1966, 1,000 cars total, the first 100 with four-speeds and the rest with C-4 automatics, 306 hp and 0-60 in 6.6 s, 800 Raven Black, and the repurchase and resale of the fleet."
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "The 1968 move: quality and financial problems pushing Ford to take over engineering and purchasing, A.O. Smith at Ionia contracted to fix glassfiber fitment, relocation by August 1967, a nine-month run fed by part-built cars railed from Metuchen, and termination of the agreement in summer 1969."
  },
  {
  ...
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "The alternative 1966 arithmetic: 2,388 cars comprising 1,368 standard, 1,001 Hertz, six convertibles and eleven Paxton cars at 380-400 hp, plus 526 for 1965. Also the engine work (Cobra alloy inlet, Holley 715, Tri-Y headers, 271 to 306 hp) and the Detroit Locker axle."
  },
  {
   "ref": "revology-1967",
  ...
  },
  {
   ...
   "reliability": "medium",
   "notes": "Gives 1,174 GT350s for 1967 against 2,050 GT500s - one and two cars different from Revology - plus the glassfiber wings and hood, brake ducts, Cougar tail lamps and the demotion of headers to an option."
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "The only source consulted that breaks 1968 down: 1,253 fastbacks and 404 convertibles. Also the 302 at 250 hp and 310 lb-ft against the 289's 306 hp, Paxton and ram-air options, 3,146 lb curb and $4,117/$4,238 prices."
  },
  {
  ...
  },
  {
   ...
   "sourceType": "encyclopedia",
   "reliability": "medium",
   "notes": "Independent corroboration of 789 and of the re-serialling mechanics: no 1970 production, unsold 1969 models given 1970 numbers under FBI supervision, the first VIN character changed from 9 to 0, replacement plates and paperwork, a chin spoiler and two black hood stripes."
  },
  {
   ...
   "sourceType": "journalism",
   "reliability": "medium",
   "notes": "Authentication and inspection guidance: verify through the SAAC registry, match VINs across Ford and Shelby documents and to the engine block, check the T-10M case is aluminum not cast iron, and inspect floors, shock towers, frame rails and screen surrounds. States 1,001 Hertz cars."
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "Restorer's fault list for 1965-68 cars: lap joints trapping salt with shock towers and frame rails the hardest repairs; wavy glassfiber and mismatched paint from new on 1967-68 cars; stock brakes underpowered; reproduction ball joints pressed in rather than spot-welded; chronic windshield leaks."
  },
  {
   "ref": "rm-mo25-5s137",
 ...
 "claims": [
  ...
  {
   "section": "specs",
   "claimText": "The 1965-1967 cars used Ford's K-code Hi-Po 289 modified by Shelby American with an aluminum Cobra inlet manifold, a Holley 715 cfm four-barrel and tubular Tri-Y headers, rated at 306 hp at 6,000 rpm and 329 lb-ft at 4,200 rpm against the standard engine's 271 hp.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
  ...
  {
   "section": "history",
   "claimText": "Assembly moved from California to A.O. Smith Corporation at Ionia, Michigan in August 1967 because of glassfiber fitment and quality problems, Shelby American's limited capacity and the expiry of its airport lease, with Ford taking control of engineering and purchasing and supplying part-built cars by rail from its Metuchen, New Jersey plant.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
  ...
  {
   "section": "production",
   "claimText": "Two sources agree that 1969 GT350 production comprised 1,085 fastbacks and 194 convertibles, making 1969 the last year in which GT350s were actually built, by then powered by a 351 cu in Windsor V8 rated at 290 hp at 4,800 rpm.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "mustangspecs-1969",
