...
export const seedRx7Fc = {
 ...
 "notableTrims": [
  ...
  },
  {
   ...
   "note": "The domestic turbocharged grades, sold under the Savanna name Mazda reserved for Japan while export markets used RX-7 alone. Right-hand drive, 182 hp rising to 202 hp."
  },
  {
   "name": "Infini I-IV (Japan)",
   "note": "Four annual limited series of roughly 600 cars, with Bilstein dampers, BBS wheels, a limited-slip differential and series-specific colors. The final cars were rated at 212 hp, the highest factory output of the generation."
  }
 ],
 "specs": {
 ...
 "sources": [
  ...
  },
  {
   ...
   "reliability": "medium",
   "notes": "States 'over 250,000' FCs built; independent rear suspension with DTSS; Turbo II launched 1987 with a twin-scroll turbocharger; the 1989 update to 160 and 200 hp; and the claim that the convertible took turbocharged engines outside the United States."
  },
  {
  ...
  },
  {
   ...
   "sourceType": "encyclopedia",
   "reliability": "medium",
   "notes": "654 cc chamber volume and 2,616 cc equivalent displacement; 9.4:1 and 9.0:1 compression; S4 146 hp, S5 160 hp, S4 turbo 182 hp, S5 turbo 202 hp; gear ratios 3.483 to 0.806; final drives 4.300 and 4.100; discs 277/274 mm; curb weights 2,626-2,723 lb."
  },
  {
   "ref": "encycarpedia-fc",
   ...
   "sourceType": "encyclopedia",
   "reliability": "medium",
   "notes": "Series 5 Turbo II reference data: 197 hp, 195 lb-ft, 0-60 mph in 6.5 seconds, 143 mph, 2,888 lb curb weight, MacPherson strut front and trailing-arm rear suspension, 205/55 ZR16 tires."
  },
  {
   "ref": "jdmbuysell-fc3s",
  ...
  },
  {
   ...
   "reliability": "low",
   "notes": "Owner and preparer discussion of DTSS hardware: the toe-control bushings work as intended when new on factory tire widths but become unpredictable in transitions once aged or run wider; lateral rod ball joints develop play. Fault patterns only."
  },
  {
 ...
 "claims": [
  ...
  {
   "section": "specs",
   "claimText": "The turbocharged 13B-T ran 9.0:1 compression and produced 182 hp at 6,500 rpm with 183 lb-ft at 3,500 rpm as the Series 4 Turbo II, rising to 200 hp and 195 lb-ft for the Series 5 at a quoted 6.5 seconds to 60 mph and 143 mph, with Japanese-market cars quoted at 182 hp, then 202 hp, and 212 hp in the Infini series.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "wikipedia-rx7",
  ...
  {
   "section": "specs",
   "claimText": "The 13B-T used a single turbocharger with a twin-scroll housing, a split intake manifold, lower-compression rotors and an air-to-air intercooler fed by a hood duct, but sources disagree on whether the twin-scroll arrangement was present from the Turbo II's introduction or arrived with the Series 5 cars.",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": [
    "hpacademy-13b",
  ...
  {
   "section": "problems",
   "claimText": "The DTSS toe-control bushings behave as intended only when new and on factory tire widths; aged bushings or wider modern tires make the car unpredictable in transitions, which is why race preparers fit bushings that disable the rear steer entirely.",
   "confidence": "medium",
   "status": "verified",
   "sourceRefs": [
    "grassroots-lucky7",
