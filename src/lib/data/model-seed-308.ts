...
export const seed308 = {
  ...
  specs: {
    ...
    'Power (carb, Euro)': '252 hp @ 6,600 rpm',
    'Power (carb, US)': '237 hp @ 6,600 rpm (emissions-equipped)',
    'Power (GTBi/GTSi, Euro)': '211 hp - the injection-era dip',
    'Power (Quattrovalvole, Euro)': '240 hp @ 7,000 rpm; ~230 hp US (SAE net)',
    'Torque (QV, Euro)': '192 lb-ft (260 N·m) @ 5,000 rpm',
    ...
    'Weight (vetroresina)': '~2,315 lb',
    'Weight (steel/GTBi)': '~2,835 lb',
    'Wheelbase': '92.1 in (2,340 mm) (92.1 in)',
...
The most collectible 308s are the earliest. Although built by Carrozzeria Scaglietti, the first GTBs wore bodywork made entirely of glass-reinforced plastic ("vetroresina" in Italian) - the first time Ferrari used the material on a production car. The payoff was weight: roughly 2,315 lb, the lightest of the whole line. Around June 1977 Ferrari switched to steel bodies, which added on the order of 331 lb. Exactly how many fiberglass cars were built is genuinely disputed (see the production claims) - commonly cited as 808, but the marque register and some chassis-range studies argue for ~712.

## GTS targa and the carbureted core

The targa-topped 308 GTS arrived at the 1977 Frankfurt show with a removable satin-black roof panel that stowed behind the seats. All GTS cars were steel-bodied and used wet-sump lubrication; European GTB coupes kept dry-sump engines until 1981. Carbureted cars ran four twin-choke Weber 40DCNF carburetors, with European output of 252 hp and US cars detuned to around 237 hp by emissions gear.

## Injection, the power dip, and the Quattrovalvole fix

In 1980 Ferrari fitted Bosch K-Jetronic mechanical fuel injection to meet tightening emissions rules, renaming the cars 308 GTBi and GTSi. Cleaner, yes - but slower: European output fell to about 211 hp and US cars to roughly 202 hp, the low point of the range and the reason injected non-QV cars are the enthusiasts’ least-favorite. Ferrari’s answer came in 1982 with the 308 Quattrovalvole (“four valves”): new four-valve-per-cylinder heads pushed European power back to about 240 hp and, as a bonus, replaced the troublesome sodium-filled exhaust valves of the two-valve engines. The QV ran until the 328 replaced it in 1985.`,

  marketNotes: `The 308’s pop-culture halo is unusually strong: Tom Selleck’s red 308 GTS in Magnum, P.I. (1980-1988) made the targa shape an icon, and that association still colors the market - a series-used “ROBIN 1” car is a different (and far pricier) animal than an ordinary 308.

As a snapshot rather than a quote (mid-2020s): aggregated public listing/auction data (classic.com) and Hagerty’s valuations put ordinary, sound driver-grade 308 GTS cars broadly in the high-five-figures, with exceptional, low-mileage or documented examples higher, and the early carbureted GTB - especially the fiberglass vetroresina - commanding a clear premium over later steel injected cars. Within the range the rough collector hierarchy runs: vetroresina GTB and carbureted dry-sump cars at the top; carbureted GTS next; Quattrovalvole respected for usability and power; and the GTBi/GTSi injected non-QV cars generally the most affordable way in (precisely because of the power dip).
...
**Rust on steel cars.** From mid-1977 on the bodies are steel and rust like any car of the era - check the sills, lower doors, the rear of the front wings/arches, and along the black-painted belt line. On the early fiberglass vetroresina cars the panels don’t rust, but water can sit between body and frame, so inspect the steel chassis underneath rather than assuming you’re safe.
...
**Electrical gremlins.** Disorganized factory under-dash wiring, failing switchgear, and overheating fuse-box connections are common and time-consuming.
...
**The injection-era power dip.** Not a "fault" but worth knowing: GTBi/GTSi cars are noticeably down on power versus both the earlier carbureted cars and the later QV - set expectations accordingly.`,
  ...
  sources: [
    ...
    },
    {
      ...
      sourceType: 'reference-book',
      reliability: 'medium',
      notes: 'Marque reference using chassis-range data; gives the 712 fiberglass figure (chassis 18677-21289) and per-variant splits, dry/wet sump details.',
    },
    {
      ref: 'hagerty-uk',
  ...
  claims: [
    ...
    },
    {
      section: 'production',
      claimText:
        'Only the early fiberglass ("vetroresina") GTB cars used Ferrari’s first GRP production body (~2,315 lb); production switched to steel around June 1977.',
      confidence: 'high',
      status: 'verified',
    ...
    },
    {
      section: 'production',
      claimText:
        'Approximately 808 fiberglass vetroresina GTBs were built.',
      confidence: 'medium',
      status: 'disputed',
      sourceRefs: ['wikipedia', 'reg308', 'supercarnostalgia'],
      conflictNote:
        'Ferrari and Wikipedia (citing Sports Car Market) state 808 fiberglass cars; the 308 GTB Register and chassis-range studies (e.g. Supercar Nostalgia, chassis 18677-21289) argue for ~712. Both figures appear in reputable marque sources. We present 808 as the most-cited number and flag ~712 as the well-supported alternative rather than picking a winner.',
    },
    {
      section: 'specs',
      claimText:
        'Carbureted European 308s produced about 252 hp; US emissions-equipped cars were down to about 237 hp.',
      confidence: 'medium',
      status: 'disputed',
      sourceRefs: ['wikipedia', 'ferrari', 'hagerty-uk'],
      conflictNote:
        'Sources vary on the carbureted figure: Wikipedia/Ferrari cite 252 hp (Euro) and 237 hp (US), while many enthusiast write-ups and guides quote a round "240 hp" for the European carb car (sometimes conflating Euro and US, or DIN vs SAE measurement). We carry 252 hp Euro / 237 hp US as the best-documented split and note the widely repeated 240-hp figure.',
    },
    {
      section: 'specs',
      claimText:
        'Bosch K-Jetronic fuel injection on the 1980-82 GTBi/GTSi cut European output to about 211 hp and US output to roughly 202 hp - the well-documented "power dip" of the range.',
      confidence: 'high',
      status: 'verified',
