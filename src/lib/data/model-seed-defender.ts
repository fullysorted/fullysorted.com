...
export const seedDefender = {
 ...
 "engines": [
  "2.25L and 2.5L naturally aspirated gasoline and diesel four-cylinders (early One Ten/Ninety, pre-Tdi)",
  ...
  "3.5L / 3.9L / 4.0L Rover V8 gasoline (Euro-market V8s; 3.9L EFI and 4.0L GEMS in NAS-spec US trucks)"
 ],
 ...
 "notableTrims": [
  ...
  },
  {
   ...
   "note": "US/Canada federalized 110 Station Wagon with the 3.9-liter EFI V8 and five-speed manual, sold as a halo model ahead of the D90. Roughly 500-525 for North America; the rarest official US Defender."
  },
  {
   "name": "NAS Defender 90 (1994, 1995, 1997)",
   "note": "V8-only US-spec 90. 3.9-liter EFI V8 for 1994-95; 4.0-liter GEMS V8 for 1997, when an automatic became available. Soft tops from 1994, Station Wagons added for 1995."
  },
  {
 ...
 "specs": {
  ...
  "construction": "Steel ladder-frame chassis with aluminum alloy body panels over steel frames and a steel bulkhead",
  "wheelbase_90": "92.9 in (2,360 mm)",
  "wheelbase_110": "110 in (2,794 mm)",
  "wheelbase_130": "127 in (3,226 mm), despite the 130 badge",
  "power_200tdi": "~107 hp, 195 lb-ft",
  "power_300tdi": "~111 hp, 195 lb-ft",
  "power_td5": "~122 hp",
  "power_24_tdci": "~122 hp, 265 lb-ft, six-speed manual",
  "power_nas_110": "3.9L EFI Rover V8, ~180 hp / 227 lb-ft, five-speed manual",
  "power_nas_90": "3.9L EFI V8 ~182 hp / 232 lb-ft (1994-95); 4.0L GEMS EFI V8 (1997)",
  "factory_corrosion_protection": "Painted/primed steel chassis; factory chassis were not hot-dip galvanized",
 ...
 "sources": [
  ...
  },
  {
   ...
   "sourceType": "reference-book",
   "reliability": "medium",
   "notes": "One Ten introduced 1983, Ninety 1984; Defender name from 1990; steel ladder chassis with aluminum alloy bodywork; NAS 1993 figure given as 500 US plus 25 Canada."
  },
  {
   "ref": "hagerty-90-110",
   ...
   "reliability": "high",
   "notes": "Valuation overview: auction range $20,350-$125,500, #2-condition median ~$28,300 for a 1990, peak late 2010-early 2015 then flat, V8 > gasoline four > diesel, 90 > 110, soft top > pick-up; US sales 1993-97 ended by airbag law."
  },
  {
   "ref": "classic-d90-nas",
  ...
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "Year-by-year NAS D90 counts: 1994 2,030 soft tops (US/Canada); 1995 1,190 soft top plus 510 station wagon; 1997 1,499 soft top plus 1,300 station wagon; no 1996 model year; 3.9 V8 182 hp for 1994-95, 4.0 GEMS V8 for 1997."
  },
  {
   "ref": "bishoprook",
 ...
 "claims": [
  ...
  {
   "section": "production",
   "claimText": "Land Rover sold the NAS Defender 110 in North America for the 1993 model year only, with the 3.9-liter EFI V8 and a five-speed manual, in a run of roughly 500 to 525 vehicles for the US and Canada combined.",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": [
    "wikipedia-defender",
  ...
  {
   "section": "production",
   "claimText": "The NAS Defender 90 was sold for 1994, 1995 and 1997 with no 1996 model year, using the 3.9-liter EFI V8 for 1994-95 and the 4.0-liter GEMS V8 for 1997, for a total on the order of 6,500 vehicles.",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": [
    "ecr-d90",
  ...
  {
   "section": "problems",
   "claimText": "Original production Defender chassis were not hot-dip galvanized from the factory but left Solihull with primer and black chassis paint, so a galvanized chassis on a Defender indicates a replacement frame rather than original specification.",
   "confidence": "medium",
   "status": "verified",
   "sourceRefs": [
    "rustbuster-chassis"
  ...
  {
   "section": "problems",
   "claimText": "The most expensive corrosion points are the steel bulkhead - around the windshield frame, fresh-air vents and footwells - followed by the rear crossmember, outriggers, engine support rails and rear spring and axle mounts.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "classicsworld-guide",
  ...
  {
   "section": "market",
   "claimText": "Hagerty reports an auction range of roughly $20,350 to $125,500 for the 90/110, a #2-condition median near $28,300 for a 1990 truck, a value peak between late 2010 and early 2015 followed by relatively flat trading, and a premium structure favoring V8 over four-cylinder, 90 over 110 and soft top over pick-up.",
   "confidence": "medium",
   "status": "verified",
   "sourceRefs": [
    "hagerty-90-110"
