...
export const seed190ECosworth = {
 ...
 "specs": {
  ...
  "chassis": "Unitary steel monocoque W201 shell, 104.9 in (2,665 mm) wheelbase; MacPherson strut front with the coil springs mounted separately from the dampers, anti-dive geometry, front and rear anti-roll bars",
  ...
  "brakes": "11.2 in (284 mm) ventilated front and 10.2 in (258 mm) solid rear discs on the 2.3-16; 11.8 in (300 mm) front and 10.9 in (278 mm) rear on both Evolutions, the Evolution II adding lighter alloy four-piston calipers",
 ...
 "claims": [
  ...
  },
  {
   ...
   "conflictNote": "Wikipedia states 500 cars in blauschwarz with numbers 501 and 502 in astral silver. mb190e16v.com calls the two silver cars test cars. Octane says one went to AMG and one was kept by Mercedes-Benz. Supercar Nostalgia refers to two VIP examples in another scheme. The gearknobs run 001/500 to 500/500, yet RM Sotheby's catalogs describe cars as serial 168 and 283 'of 502'. No source consulted resolves this."
  },
  {
   "section": "specs",
  ...
  },
  {
   ...
   "conflictNote": "RM Sotheby's catalogs state the model secured constructors' titles in both 1991 and 1992, and autoevolution states AMG-Mercedes lifted the manufacturers' trophy in 1991. Octane says the 1991 championship went to BMW. Wikipedia records Frank Biela's Audi V8 quattro as 1991 drivers' champion, which settles the drivers' title but not the manufacturers' award. The question is not resolved by any source consulted here."
  },
  {
   "section": "market",
