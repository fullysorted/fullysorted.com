...
export const seed250GtLusso = {
 ...
 "engines": [
  "2,953 cc Tipo 168/U Colombo 'short-block' 60-degree V12, single overhead camshaft per bank, two valves per cylinder, outside-plug heads, three twin-choke Weber 36 DCS carburettors, 240 hp claimed by Ferrari; published output ranges from 236 to 250 hp at 7,000-7,500 rpm depending on source"
 ],
 ...
 "notableTrims": [
  ...
  },
  {
   ...
   "note": "The standard car: steel body with aluminum hood, doors and trunk lid, 2,400 mm tubular chassis, Tipo 168/U V12 on three Weber 36 DCS carburettors and a four-speed gearbox. Effectively every surviving Lusso is one of these, so condition and documentation decide value rather than specification."
  },
  {
 ...
 "specs": {
  ...
  "chassis": "Tipo 539/U tubular steel chassis, 2,400 mm wheelbase, derived from the 250 GTO structure with narrower tubes; steel body with aluminum hood, doors and trunk lid",
