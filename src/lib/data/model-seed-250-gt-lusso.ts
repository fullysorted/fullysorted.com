...
export const seed250GtLusso = {
 ...
 "notableTrims": [
  ...
  },
  {
   ...
   "note": "The standard car: steel body with aluminum hood, doors and trunk lid, 94.5 in (2,400 mm) tubular chassis, Tipo 168/U V12 on three Weber 36 DCS carburetors and a four-speed gearbox. Effectively every surviving Lusso is one of these, so condition and documentation decide value rather than specification."
  },
  {
 ...
 "specs": {
  ...
  "chassis": "Tipo 539/U tubular steel chassis, 94.5 in (2,400 mm) wheelbase, derived from the 250 GTO structure with narrower tubes; steel body with aluminum hood, doors and trunk lid",
  "engine": "2,953 cc Tipo 168/U Colombo 60-degree V12, single overhead camshaft per bank, two valves per cylinder, outside-plug heads, three Weber 36 DCS twin-choke carburetors",
  "bore_stroke": "73 mm x 58.8 mm",
  "compression": "9.2:1 per Supercars.net; not stated by Ferrari",
  "power": "240 hp claimed by Ferrari (rpm not stated); Wikipedia and RM Sotheby's give 240 hp at 7,500 rpm, Gooding 240 hp at 7,000 rpm, Yahoo/Autoblog 236 hp at 7,500 rpm, Drive-My 250 hp at 7,000 rpm and Supercars.net 250 hp at 7,500 rpm",
  "torque": "178 lb-ft at 5,500 rpm per Wikipedia and conceptcarz; 188 lb-ft per Drive-My; 215 lb-ft per Supercars.net",
  ...
  "wheels_tires": "Borrani wire wheels with knock-off hubs; 185VR15 Pirelli Cinturato CA67 per Wikipedia",
  "weight": "Published figures range from 2,249 lb (Supercars.net) to 2,892 lb (Drive-My road test); Wikipedia gives 2,249-2,888 lb depending on equipment. No factory figure was found",
  "dimensions": "Length 173.6 in (4,410 mm), width 68.9 in (1,750 mm), height 50.8 in (1,290 mm) per Supercars.net",
  "top_speed_claimed": "150 mph, widely repeated; Drive-My cites 149 mph. Period claims, not independently verified here",
  "acceleration": "0-60 mph in 7.9 s (Drive-My) or 8.0 s (GTspirit); Wikipedia gives 0-62 mph in 7-8 s. Supercars.net's 5.2 s is an outlier and is not relied on",
  ...
  "original_price": "$13,375 in the United States"
 },
 "summary": "The Ferrari 250 GT Berlinetta Lusso (1962-1964) was the last of the 250 GT road cars and the one built for the road rather than the track. Pininfarina drew it, Scaglietti built all but a few of the bodies in steel with aluminum opening panels, and the prototype appeared at the Paris Motor Show in October 1962. Underneath sat a 94.5 in (2,400 mm) tubular chassis developed from the 250 GTO, with the GTO's concentric-spring rear dampers and Watts linkage, Dunlop discs on all four corners and the 2,953 cc Colombo V12 in Tipo 168/U form on three Weber 36 DCS carburetors, rated by Ferrari at 240 hp. Production ran for about eighteen months before the 275 GTB replaced it; Ferrari says 350 cars, some references say 351, and the difference is not explained anywhere. The Lusso sits between the 250 GT SWB and the 250 GTE 2+2, faster and better resolved than the four-seater, softer and more habitable than the SWB. Steve McQueen ordered one new in brown and kept it ten years. Today it is the most affordable way into a Scaglietti-bodied 250 berlinetta, which in this context means a seven-figure car.",
 "history": "## The Last of the 250 GT Line\n\nFerrari's 250 series began with the 250 S of 1952 and by 1962 had produced the 250 GT SWB berlinetta, the 250 GTO and the 250 GTE 2+2, all on the same 2,953 cc Colombo V12. The Berlinetta Lusso was the closing chapter. It was conceived as a two-seat road car for customers who wanted a Scaglietti-bodied berlinetta without the SWB's austerity or the GTE's extra seats, and it was never intended for sports car racing. Ferrari's own account is that the prototype, chassis 3849GT, was shown at the 1962 Paris Motor Show, that Pininfarina built it and a few early cars itself, and that Scaglietti bodied the rest through to the latter part of 1964, when the 275 GTB took over.\n\n## What Came from the GTO\n\nThe chassis is the interesting part. The Lusso's 94.5 in (2,400 mm) tubular frame, Ferrari factory type 539/U, was developed from the 250 GTO's structure with narrower tubes, and RM Sotheby's catalog for chassis 5129 notes that the concentric coil springs around the rear telescopic dampers and the Watts linkage stabilizing the live axle were both developed on the racing car. Brakes were Dunlop discs all round with servo assistance, wheels were Borrani wires on knock-off hubs, and the suspension was double wishbones and coils at the front with semi-elliptic leaves at the rear. The engine was moved forward in the frame relative to the SWB, which is why the cabin is roomier and the car rides better; the trade is a nose-heavier balance than the competition cars.\n\n## Engine and Gearbox\n\nThe Tipo 168/U engine is the 'short-block' Colombo V12 at 2.9 in (73 mm) by 2.3 in (58.8 mm), single overhead camshaft per bank, two valves per cylinder, outside-plug heads and three twin-choke Weber 36 DCS carburetors. Ferrari claims 240 hp. Other credible sources give anything from 236 to 250 hp and place the peak at either 7,000 or 7,500 rpm; the spread is typical of period Ferrari output figures and no source reconciles it. Torque is quoted at 178 lb-ft at 5,500 rpm by most references. The gearbox was a four-speed all-synchromesh unit with two alternative final-drive ratios. Wikipedia records period criticism that the car was too high-geared, and both modern road tests consulted note that the V12 wants 1,500 to 2,500 rpm before it pulls cleanly in the higher gears. The tachometer's red zone begins at 8,000 rpm.\n\n## The Body and the Cabin\n\nPininfarina's shape has a long hood, slim pillars, full-length wings and a truncated Kamm tail with a small integrated lip, which Wikipedia describes as the first on a Ferrari road car. The body was steel with aluminum hood, doors and trunk lid. The interior was unusual: a nearly vertical three-spoke Nardi wheel, a leather-covered dash with the tachometer and speedometer set in the center and angled toward the driver, five secondary gauges ahead of the driver, fixed seat backs and pedals adjustable through about 5 cm. Original US list price was $13,375.\n\n## Owners, Races and the Long Tail\n\nThe Lusso has always been the 250 that people drove. Steve McQueen ordered chassis 4891 new in 1963 in metallic brown over beige and kept it for a decade; Wikipedia says he parted with it complaining about exhaust smoke under hard acceleration, and Eric Clapton owned one later. A small number of cars were raced privately, with Ferrari recording thirteenth overall at the 1964 Targa Florio and entries at the 1965 Targa Florio and Tour de France. Chassis 4383 was partly rebodied by Fantuzzi for Tecno's Luciano Pederzani. Around 22 or 23 cars were built right-hand drive for Maranello Concessionaires. Chassis 5783 GT, delivered in Rome in July 1964, had covered 19,884 miles by its third service two years later, which is a fair picture of how these cars were used. The model's reputation was made by exactly that usability, and its market has followed the SWB and GTO upward at a respectful distance ever since.",
 "marketNotes": "As of September 2026, classic.com's market benchmark for the 250 GT Berlinetta Lusso stands at $1,645,130 on an upward trend, with an average recorded sale of $1,569,407. Tracked results run from $907,000 in August 2023 to $3,300,000 on 17 January 2026, a record that The Classic Valuer attributes to Mecum. Fetched lot results through 2026 cluster well below the outlier: Gooding Christie's sold chassis 5127, a three-year restored car documented by Marcel Massini, for $1,765,000 at Amelia Island on 6 March 2026 against a $1.6 to $1.8 million estimate; Broad Arrow sold a 1963 car for $1,490,000 at Amelia on 7 March 2026; and Mecum sold chassis 4635, Classiche certified with a documented $600,000 restoration, for $1,650,000 at Monterey on 15 August 2026. Earlier comparables: RM Sotheby's Arizona, January 2024, chassis 5129 after 39 years in one ownership, $1,352,500; Gooding's Geared Online sale of chassis 5931 in 2020, $1,430,000; RM Sotheby's Villa Erba, May 2017, chassis 5681 in dark brown, $1,598,789 including premium, with Sports Car Market observing that the market had averaged $2.3 million at the 2014 peak and $1.7 million by 2016. Named provenance moves the model outside its normal band, as the $2.3 million McQueen result of August 2007 first demonstrated.",
 "whatToLookFor": "The Lusso market rewards documentation over almost everything else, because nearly all of the 350-odd cars are mechanically alike. Marcel Massini's chassis histories appear in the catalog text of most serious sales, and Ferrari Classiche certification with the Red Book is cited on the strongest recent results, including Mecum's chassis 4635 and Girardo's chassis 5443. Classiche confirms that engine, gearbox and rear axle numbers match the factory build sheet; a car sold as 'matching numbers per factory records', as Gooding described chassis 5931, is making a similar claim on different evidence, and it is worth understanding which. Several cars have received engines from other 250s over the years, and Magneto records a 275 GTS engine having been fitted to chassis 4607 GT during a past restoration, so engine number against chassis number is the first check. Establish the color history: original combinations such as Grigio Fumo, Azzurro or Grigio Argento are recorded on the build sheet, and a car returned to its delivery color reads better than one in a later red. Restoration age matters; Sports Car Market noted that a 30-year-old refinish held chassis 5681 back at Villa Erba. Steel bodies on tubular frames need a proper look at sills, floors and the lower rear quarters, and the 2014 Salon Prive listing for 5443 describes chassis dipping as part of a full restoration for a reason. Ask for a compression test and a complete history file; DK Engineering, quoted by Drive-My, gives both as the minimum before purchase because engine repairs are expensive. Check that the correct Borrani wheels, Nardi wheel and center-dash instrument layout are present, and that the aluminum opening panels have not been replaced in steel. Right-hand drive with UK importer paperwork is a distinct sub-market. Finally, a car with evidence of being driven, like the 19,884 miles in two years recorded for chassis 5783, is not a lesser car in this model's world.",
 "commonProblems": "Published ownership writing on the Lusso is thin compared with later Ferraris, and the notes below rest on a handful of sources. The engine's character faults were known in period: Wikipedia records major exhaust smoke under hard acceleration and vibration around 3,700 rpm, the same smoke that Steve McQueen is said to have complained of, and the standard gearing was criticized as too tall. Both modern road tests consulted describe a V12 that is reluctant below about 1,500 to 2,500 rpm in the higher gears, so a car that drives cleanly from low revs has usually had careful carburetor and ignition setup. Engine rebuilds are the large expense; Drive-My's marque specialist advises a compression test before purchase for exactly that reason, and the auction catalogs consulted describe rebuilt engines on several cars, including chassis 4635 in 1996. Routine servicing is not the problem. The steel body over a tubular frame corrodes in the usual places and a full restoration involves stripping to bare metal, as the Salon Prive sale description of chassis 5443's rebuild makes clear, listing chassis dipping, panel work, a complete rewire, differential and gearbox reconstruction and Weber refurbishment. Weber 36 DCS carburetors need periodic rebuilding, and the Dunlop disc and servo system needs correct sealing to work as intended. Interior leather, the leather-covered dash and correct headlining are all expensive to redo properly; the 5443 restoration used four hides. Beyond that, the recurring risk on this model is provenance rather than mechanics: replaced engines, changed colors and gaps in the history file.",
 "valueTrajectory": "The Lusso listed at $13,375 in 1963 and spent its first decades as the affordable Scaglietti 250, valued well below the SWB and far below the GTO. CNN's 2007 report on the McQueen sale put an ordinary car at $600,000 to $800,000 at that point, with McQueen's own car making $2.3 million at Christie's Monterey that August. The 2011-2014 classic boom carried the model to an average around $2.3 million by 2014 according to Sports Car Market, after which it eased to roughly $1.7 million by 2016 and has traded in a band since. As of September 2026, classic.com's benchmark is $1,645,130 with recent fetched results of $1,490,000 to $1,765,000 for good restored cars at Amelia Island and Monterey in 2026, which is broadly where the market sat a decade ago in nominal terms. The $3,300,000 result of January 2026 shows what an exceptional car or story can do, and the Classic Valuer's 72 per cent sell-through across 82 sales suggests a market that is liquid but discriminating. The gap between a Classiche-certified, Massini-documented, original-color car and one with a replaced engine or a stale restoration is the part of this market that is moving.",
 ...
 "sources": [
  {
   ...
   "reliability": "high",
   "notes": "Ferrari's model record: presented at the 1962 Paris Motor Show, production to the latter part of 1964 'by which time 350 cars had been produced'; 2,400 mm tubular chassis type 539/U; engine type 168/U, 2,953 cc, 73 x 58.8 mm, three Weber 36 DCS, 240 hp claimed; four-speed all-synchromesh gearbox with two alternative axle ratios; odd GT-suffix chassis numbers; prototype 3849GT; Scaglietti bodied all but a few; steel with aluminum opening panels; Targa Florio 1964 (thirteenth) and 1965, Tour de France 1965."
  },
  {
   "ref": "wikipedia-lusso",
  ...
  },
  {
   ...
   "reliability": "high",
   "notes": "Sold $1,352,500, Arizona, January 2024. Chassis 5129 'the 129th of 350 examples built'; engine 5129, gearbox 121, axle 123; steel body with aluminum hood and doors; 2,953 cc short-block V12 with outside-V plugs and single-port heads; concentric rear springs and Watts linkage developed on the GTO; 39 years single ownership from 1984, 1,944 miles in that period."
  },
  {
   ...
   "sourceType": "auction-house",
   "reliability": "high",
   "notes": "Lot 134, Amelia Island, March 2026: sold $1,765,000 against $1,600,000-1,800,000 estimate. Chassis 5127 GT, engine 5127; 'One of Only 350 Lussos Built'; 2,953 cc SOHC Tipo 168U V12, 240 hp at 7,000 rpm, three Weber 36 DCS, four-speed, four-wheel Dunlop discs; delivered to Milan in Grigio Fumo; three-year restoration; Massini documented."
  },
  {
  ...
  },
  {
   ...
   "sourceType": "journalism",
   "reliability": "medium",
   "notes": "Modern road test of chassis 5783 GT: 250 hp at 7,000 rpm, 188 lb-ft at 5,500 rpm, 2,892 lb, 149 mph, 0-60 in 7.9 s, 17 mpg, 5,607 pounds new; 350 built; engine needs 2,500 rpm to pull; delivered Rome 6 July 1964 and 19,884 miles by its third service; DK Engineering: annual servicing under 2,000 pounds, obtain full history and a compression test because engine repairs are expensive."
  },
  {
  ...
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "Specification sheet: 'around 350' built; Paris Salon October 1962; 2,953 cc, 73 x 58.8 mm, 9.2:1, 250 hp at 7,500 rpm, 215 lb-ft at 5,500 rpm; gear ratios 2.54/1.70/1.26/1.00; Borrani RW3801 wheels; 4,410 x 1,750 x 1,290 mm; 2,249 lb; $13,375; shares wheelbase, discs, Borranis, suspension and engine with the GTO. Its 5.2 s 0-60 figure is out of line with every other source."
  },
  {
 ...
 "claims": [
  ...
  {
   "section": "history",
   "claimText": "Pininfarina designed the body and built the prototype and a few early cars; Scaglietti built the rest, in steel with aluminum hood, doors and trunk lid.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "ferrari-lusso",
  ...
  {
   "section": "production",
   "claimText": "Total production is stated as 350 cars by Ferrari and by most auction catalogs, and as 351 by Wikipedia, conceptcarz and classic.com; the one-car difference is not explained by any source and no single figure is asserted here.",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": [
    "ferrari-lusso",
   ...
   "conflictNote": "Ferrari's model page states 350. RM Sotheby's (chassis 5129 'the 129th of 350'; chassis 4383 'the 16th of 350'), Gooding (2020 and March 2026), Sports Car Market, Mecum's catalog text, CNN, Drive-My and GTspirit all state 350. Wikipedia states 351, conceptcarz states 351 and classic.com states 'approximately 351'. Whether the extra car is the Paris prototype is not stated by any source. Unresolved; productionTotal is null."
  },
  {
   "section": "production",
  ...
  {
   "section": "specs",
   "claimText": "The engine is the 2,953 cc Tipo 168/U Colombo short-block V12, bore and stroke 73 mm x 58.8 mm, single overhead camshaft per bank, outside-plug heads, on three Weber 36 DCS twin-choke carburetors, driving through a four-speed all-synchromesh gearbox with two alternative final-drive ratios.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "ferrari-lusso",
  ...
  {
   "section": "specs",
   "claimText": "Ferrari claims 240 hp for the Lusso; other credible sources quote between 236 and 250 hp with the peak at either 7,000 or 7,500 rpm, and torque figures range from 178 to 215 lb-ft, so the output is best read as a period claim of about 240 hp rather than a measured figure.",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": [
    "ferrari-lusso",
   ...
   "conflictNote": "Ferrari: 240 hp, no rpm. Wikipedia and RM Sotheby's (chassis 4383): 240 at 7,500 rpm. Gooding Amelia 2026: 240 at 7,000 rpm. Yahoo Autos preview of the same car: 236 hp at 7,500 rpm. Drive-My: 250 at 7,000 rpm. Supercars.net: 250 at 7,500 rpm. Sports Car Digest: 250. Torque: 178 lb-ft (Wikipedia, conceptcarz), 188 lb-ft (Drive-My), 215 lb-ft (Supercars.net). No source reconciles these; unresolved."
  },
  {
   "section": "specs",
   "claimText": "The chassis is a 94.5 in (2,400 mm) wheelbase tubular steel frame, Ferrari type 539/U, developed from the 250 GTO with narrower tubes, carrying the GTO's concentric coil-over rear dampers and Watts linkage on a live axle, double wishbones and coils at the front, servo-assisted Dunlop disc brakes and Borrani wire wheels.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "ferrari-lusso",
  ...
  {
   "section": "specs",
   "claimText": "Published curb weights range from 2,249 lb to about 2,892 lb and no factory figure was found; the claimed top speed of 150 mph and 0-60 mph times of roughly 8 seconds are period figures repeated by road tests rather than independently verified here.",
   "confidence": "medium",
   "status": "verified",
   "sourceRefs": [
    "wikipedia-lusso",
