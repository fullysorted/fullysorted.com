...
export const seedCamaro1stGen = {
 ...
 "heroPhoto": "/images/models/chevrolet-camaro-1st-gen.jpg",
 ...
 "yearEnd": 1969,
 "bodyStyles": [
  "2-door sport coupe (unitized body with bolt-on front subframe)",
  "2-door convertible"
 ],
 "engines": [
 ...
 "specs": {
  ...
  "chassis": "Semi-unibody: unitized passenger cell with a bolt-on front subframe carrying engine, gearbox and front suspension, ending under the doors",
  "wheelbase": "108.0 in (2,743 mm); 186.0 in long and 74.0 in wide for 1969",
  "engine": "230 and 250 cu in inline-sixes; 302, 307, 327, 350 and 396 cu in V8s, plus the special-order 427 - eight engines cataloged for 1967, ten for 1968 and twelve for 1969",
 ...
 "sources": [
  ...
  },
  {
   ...
   "reliability": "high",
   "notes": "Sold for $404,250 at RM Sotheby's Fort Lauderdale sale in 2016, lot 510; ZL1 number 53 of 69. Catalog states the 69 comprised 47 four-speed manuals and 22 automatics, and that a Berger Chevrolet test car stickered at $7,800."
  },
  {
   "ref": "rm-st12-pacecar",
   ...
   "sourceType": "auction-house",
   "reliability": "high",
   "notes": "Sold for $53,350 from the John Staluppi Collection in 2012: a 350/300 hp automatic Z11 convertible. Catalog independently states 3,675 pace cars of all types, this car one of 3,532 civilian replicas."
  },
  {
 ...
 "claims": [
  ...
  {
   "section": "problems",
   "claimText": "Corrosion is structural rather than cosmetic, concentrating at the subframe-to-body mounting points, rocker panels, rear fenders, floor pans, trunk pan and rear shock tower mounts; aging wiring, awkward RS vacuum headlight doors and inconsistent reproduction panel quality are the other recurring faults.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
