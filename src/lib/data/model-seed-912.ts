...
export const seed912 = {
 ...
 "engines": [
  "1,582 cc Type 616/36 air-cooled pushrod flat-four (616/39 in some US applications), 74 mm x 82.5 mm, 9.3:1, twin twin-choke carburettors, 89 hp DIN (89 hp) at 5,800 rpm, 90 lb-ft at 3,500 rpm; quoted as 102 hp SAE gross in the United States",
  "912E (1976): 1,971 cc Volkswagen Type 4 air-cooled flat-four, 94 mm x 71 mm, Bosch L-Jetronic injection, 86 hp SAE net (89 hp by Porsche's own figure) at 4,900 rpm, 98 lb-ft at 4,900 rpm"
 ],
 ...
 "notableTrims": [
  ...
  },
  {
   ...
   "note": "G-body 911 shell with the fuel-injected 2.0-liter Volkswagen Type 4 flat-four from the 914, thermal reactors, a galvanised shell and a 20-plus gallon tank. Built as a one-year stop-gap between the 914 and the 924 and priced at $10,845, $3,000 under a 911S. Not a 1965-1969 car in any mechanical sense, and traded separately."
  }
 ],
 "specs": {
  ...
  "engine": "1,582 cc Type 616/36 pushrod flat-four from the 356 SC, detuned from 95 to 89 hp; 74 mm x 82.5 mm; 9.3:1; twin twin-choke carburettors, Solex 40 PII-4 per Gooding and Stuttcars, Weber 40 IDF per the Porsche newsroom (see claims). 912E: 1,971 cc VW Type 4, 94 mm x 71 mm, Bosch L-Jetronic",
 ...
 "claims": [
  ...
  {
   "section": "problems",
   "claimText": "Rust in the floors, front trunk, battery box and the areas around the windshield and headlights is the primary concern on 1965-1969 cars; only the 912E had a galvanised shell, introduced specifically to address the 912's rust problem.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "renndriver-912",
