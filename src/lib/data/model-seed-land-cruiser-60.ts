...
export const seedLandCruiser60 = {
 ...
 "notableTrims": [
  {
   "name": "FJ60",
   "note": "Carburetted 4.2L 2F, round twin headlights, four-speed and later five-speed manual only. The US car for model years 1981-1987."
  },
  {
   "name": "FJ62",
   "note": "3F-family 4.0L six. Introduced November 1984 in limited markets with a carburetted 3F; the US version arrived for 1988 with 3F-E fuel injection and an optional A440F four-speed automatic."
  },
  {
   "name": "BJ60",
 ...
 "claims": [
  ...
  {
   "section": "history",
   "claimText": "The FJ62 was first introduced in November 1984 in limited markets with a carburetted 3F engine, well before the fuel-injected US car of 1988.",
   "confidence": "medium",
   "status": "verified",
   "sourceRefs": [
    "flex-modelyear",
