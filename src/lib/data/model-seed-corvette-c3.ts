...
export const seedCorvetteC3 = {
 ...
 "engines": [
  ...
  "427 cu in L88 racing big-block, aluminum heads, nominally rated 430 hp gross (115 built 1968, 116 built 1969)",
  "427 cu in ZL1 all-aluminum big-block (2 cars, 1969)",
  "454 cu in (7.4L) LS5 big-block, introduced 1970; 365 hp gross (1971), 270 hp SAE net (1972)",
  "454 cu in LS6 big-block with aluminum heads, 425 hp gross / 325 hp net, 1971 only, 188 built",
 ...
 "notableTrims": [
  {
   ...
   "note": "Off-catalogue racing 427s deliberately under-rated at 430 hp gross. 115 L88s in 1968, 116 in 1969, and just two all-aluminum ZL1 cars. The blue-chip end of the generation and the reason documentation matters."
  },
  {
   "name": "LT-1 (1970-1972)",
  ...
  },
  {
   ...
   "note": "Aluminum-head 454 rated 425 hp gross / 325 hp net, 188 built at $1,221. Uniquely for the period it could be ordered with an automatic. 12 of those cars carried the ZR2 package."
  },
  {
   "name": "Silver Anniversary (1978)",
   "note": "RPO B2Z two-tone silver-over-gray paint marking the Corvette's 25th year; 15,283 cars, $399. A paint option, not a limited edition, and priced accordingly."
  },
  {
 ...
 "specs": {
  ...
  "construction": "Fiberglass body over a welded steel 'birdcage' cockpit structure and a full perimeter frame",
 ...
 "sources": [
  ...
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "high",
   "notes": "LS6 425 hp with aluminum heads, 188 built at $1,221; LS5 365 hp; LT-1 330 hp; ZR1 8 and ZR2 12; compression cut for 91-octane low-lead."
  },
  {
   "ref": "corvsport-1972",
  ...
  },
  {
   ...
   "reliability": "medium",
   "notes": "Birdcage rot at A-pillar bases and windshield corners, frame kick-up over the rear axle, front frame horns, body mounts, floors, trailing arms; lift-and-torch inspection advice."
  },
  {
 ...
 "claims": [
  ...
  {
   "section": "production",
   "claimText": "The aluminum-head LS6 454 was offered in the Corvette for 1971 only, rated 425 hp gross (325 hp net), fitted to 188 cars at $1,221, of which twelve carried the ZR2 package.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "corvsport-1971",
  ...
  {
   "section": "production",
   "claimText": "Rare early performance options were built in tiny numbers: 115 L88s in 1968, 116 in 1969, and only two all-aluminum ZL1 cars in 1969.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "corvsport-1968",
  ...
  {
   "section": "problems",
   "claimText": "The dominant structural fault is corrosion of the steel birdcage at the A-pillar bases and windshield corners, along with the frame kick-up over the rear axle, front frame horns, body mounts and floors - all hidden beneath fiberglass panels that never rust.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "corvette-c3-rust",
