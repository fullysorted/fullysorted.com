...
export const seedNineElevenSc = {
 ...
 "notableTrims": [
  {
   ...
   "note": "The launch specification, with chrome window surrounds and headlight rings for 1978 only; black anodised surrounds and body-colored rings arrived for 1979. The least powerful SC and the one closest in character to the outgoing 2.7."
  },
  {
 ...
 "claims": [
  {
   "section": "history",
   "claimText": "For the 1978 model year Porsche rationalised the 911 range to two models, the 911 SC and the 911 Turbo, retiring the 2.7-liter 911 and 911 Lux and the 3.0-liter Carrera; the SC adopted the Carrera's widened rear wings and three-liter displacement.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
  ...
  {
   "section": "history",
   "claimText": "The 911 SC Cabriolet was previewed by a four-wheel-drive, Turbo-bodied prototype at the 1981 Frankfurt show, shown in production form at Geneva in March 1982 at DM 64,500, built from October 1982 with right-hand drive from February 1983, and used a three-bow hood of panel elements covering about half the roof area, with the structure rated to 152 mph.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
