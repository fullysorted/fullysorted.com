...
export const seedNineElevenSc = {
 ...
 "engines": [
  "2,994 cc air-cooled SOHC flat-six, Type 930/03, pressure-cast aluminum crankcase, Nikasil cylinders, dry sump, Bosch K-Jetronic, 178 hp at 5,500 rpm (model years 1978-1979)",
  "2,994 cc Type 930/09, compression raised to 8.6:1 with revised valves and cam timing, 185 hp (model year 1980, markets outside the United States and Japan)",
  "2,994 cc Type 930/10, compression 9.8:1, 201 hp at 5,900 rpm (model years 1981-1983, markets outside the United States and Japan)",
  ...
  "2,994 cc Type 930/18 with 935 cylinder heads, 10.3:1 compression and Kugelfischer mechanical injection, 255 hp at 7,000 rpm, fitted to the 911 SC/RS (Type 954)"
 ],
 ...
 "notableTrims": [
  {
   "name": "911 SC (1978-1979, 178 hp)",
   "note": "The launch specification, with chrome window surrounds and headlight rings for 1978 only; black anodized surrounds and body-colored rings arrived for 1979. The least powerful SC and the one closest in character to the outgoing 2.7."
  },
  {
   "name": "911 SC (1980, 185 hp)",
  ...
  },
  {
   ...
   "note": "A North American special in Platinum or Black Metallic with gray leather, fog lamps, Bilstein dampers, electric sunroof and Fuchs wheels. Numbers are given variously as 400, 408 or 468 cars."
  },
  {
  ...
  },
  {
   ...
   "note": "A Group B homologation evolution built after standard SC production ended: 935 heads, Kugelfischer injection, 255 hp on the road and around 270 in rally trim, aluminum doors and front lid, thin glass, roughly 2,330 lb. Twenty or twenty-one cars."
  }
 ],
 "specs": {
  "layout": "Rear-mounted longitudinal air-cooled flat-six, rear-wheel drive",
  "chassis": "Galvanized steel unitary body; MacPherson-strut front with longitudinal torsion bars, semi-trailing-arm rear with transverse torsion bars, anti-roll bars front and rear",
  "engine": "2,994 cc air-cooled SOHC flat-six, two valves per cylinder, pressure-cast aluminum crankcase, Nikasil cylinders, dry-sump lubrication",
  ...
  "power": "178 hp (1978-1979), 185 hp (1980), 201 hp at 5,900 rpm (1981-1983) per Porsche Classic; United States output stated as either 180 hp throughout or 172 hp from 1980, depending on source",
  "torque": "195 lb-ft at 4,200 rpm on the 180 and 185 hp engines; 197 lb-ft at 4,300 rpm on the 201 hp engine",
  "transmission": "Type 915 five-speed manual transaxle",
  "weight": "Approximately 2,557 lb (coupe) and 2,668 lb (Targa) per Supercar Nostalgia; United States cars roughly 66 lb heavier",
  "acceleration": "6.4 s to 62 mph quoted; 6.5 s to 60 mph and 18 s to 100 mph recorded by Motor Sport in May 1978 on a 180 hp car",
  ...
  "wheels": "15-inch ATS cast aluminum standard from 1978; forged Fuchs standard from 1982",
  "fuel_tank": "80 liters, mounted under the front lid",
  "fuel_consumption": "16-18 mpg recorded in period, against 21-plus mpg for the superseded 2.7"
 },
 "summary": "The Porsche 911 SC (1978-1983) is the car that kept the 911 alive. For the 1978 model year Porsche swept away the 2.7-liter 911 and the Carrera 3.0 and offered two models only: the SC and the Turbo. Its 2,994 cc flat-six carried a pressure-cast aluminum crankcase in place of the magnesium that had made the 2.7 fragile, and output climbed in two steps from 178 hp to 188 and then 204 for markets outside the United States and Japan. Management had intended the SC as the 911's last generation before the front-engined 928 took over; instead it outsold the 928 by a wide margin and, in 1981, a new chief executive extended the production plan indefinitely. The 1983 model year brought the first fully open 911, a cabriolet with a manually operated three-bow hood. Somewhere between roughly 58,900 and 60,300 cars were built, depending on which source is consulted. Today the SC sits between the fragile 2.7 and the more developed Carrera 3.2 as the least expensive air-cooled 911 that can be used properly.",
 "history": "## Rationalization, 1977\nFor the 1978 model year Porsche collapsed a sprawling 911 range into two cars. The 2.7-liter 911 and 911 Lux and the 3.0-liter Carrera all disappeared; what remained was the 911 SC and the 911 Turbo. Porsche's own account of the G-series describes the SC as adopting the Carrera's widened rear wings along with its three liters of displacement, and Motor Sport's May 1978 test framed the change plainly: the SC replaced a 165 hp 2.7 Lux and a 200 hp Carrera 3.0 with a single 180 hp car that gave away peak power to the Carrera but beat it on flexibility and driveability. That trade - less headline output, more usable engine - is the whole argument for the SC, and it has not changed in fifty years.\n\n## The Aluminum Three-Liter\nThe engine is where the SC earns its reputation. Displacement is 2,994 cc from a 3.7 in (95 mm) bore and 70.4 mm stroke, with a single overhead camshaft per bank, two valves per cylinder, Nikasil-lined barrels, dry-sump lubrication and Bosch K-Jetronic continuous injection. The significant change was the crankcase: pressure-cast aluminum in place of the magnesium used since 1968. Magnesium cases were light but soft, and the head studs passing through them had a habit of pulling their threads out, which is the defining structural weakness of the 2.7. Aluminum did not eliminate head-stud trouble; specialist accounts note that it moved the failure from the case threads to the studs themselves. It did produce an engine that tolerates mileage and heat in a way the 2.7 does not, and that is the single reason the SC is the cheapest air-cooled 911 an owner can reasonably use hard.\n\n## Three Power Steps, and a Market Split\nOutput rose twice. Porsche Classic gives 178 hp for the 1978 and 1979 model years, 185 hp for 1980 and 201 hp from 1981 to the end, while Porsche's G-series press kit dates the same two increases to late 1979 and 1980 - the same sequence expressed as production timing rather than model years. The 185 hp engine brought a compression rise to 8.6:1, revised valves and cam timing, a new oil cooler and a revised timing-chain tensioner idler arm; the 201 hp engine went to 9.8:1. Cars for the United States and Japan did not follow. What American engines actually produced is not agreed: Wikipedia states they kept the lower-compression 178 hp unit throughout, an RM Sotheby's catalogue for a 1983 United States cabriolet quotes 180 hp, and the Porsche Club of America states that emissions equipment and a restricted intake manifold cut output to 172 hp from 1980. A buyer comparing a European 201 hp car with a federal one is comparing two quite different machines.\n\n## The Model That Was Meant to Be the Last\nUnder Ernst Fuhrmann the SC was intended as the 911's closing chapter, with the front-engined 928 taking over as flagship. It did not work out that way. The SC outsold the 928 heavily - Supercar Nostalgia puts the ratio at roughly twenty to one - and in 1981 Peter Schutz arrived as chief executive and reversed the decision, by the widely repeated account extending the 911's production line on Helmuth Bott's wall chart out past the edge of the paper. Porsche's own retrospective is drier, noting only that some of the press read the two-model range as the end of the sports car and were wrong. Either way, the SC is the car that was still selling while the argument was being had.\n\n## Open Air, and the Handover\nThe last act was a roof, or the removal of one. A cabriolet prototype on the wide Turbo body, with four-wheel drive, appeared at the 1981 Frankfurt show; the production car was shown at Geneva in March 1982 and built from that October at $34,450 in the United States and DM 64,500 in Germany, the first fully open 911 and the first Porsche convertible in nearly two decades. Its three-bow hood used panel elements covering about half the roof area rather than narrow steel bows, and Porsche rated the structure to 152 mph. It sold immediately. For 1984 the 3.2-liter Carrera replaced the SC and brought with it the pressure-fed chain tensioners that were the fix for the SC's most quoted mechanical anxiety.",
 "marketNotes": "As of August 2026, classic.com's Porsche 911 SC market benchmark stands at $63,732, with the coupe at $64,811, the Targa at $55,375 and the cabriolet at $49,927. That ordering is worth noting: the cabriolet is the rarest of the three bodies and the cheapest to buy. The recorded spread is very wide. As of August 2026 classic.com's high for the SC market is $515,000 for a 1982 car sold in November 2025, an outlier it does not characterize, against a low of $2,016 for a 1981 Targa in October 2024. Auction evidence sits in a far narrower band. RM Sotheby's sold a 9,230-mile United States cabriolet from the Taj Ma Garaj collection for $52,640, and Gooding sold a European-specification 204 hp cabriolet at Amelia Island in 2025 for $62,720. For position, as of August 2026 the Carrera 3.2 coupe benchmark is $83,205 and the 930 Turbo averages $171,008 across 740 recorded sales, so the SC remains the cheapest way into the impact-bumper era.",
 "whatToLookFor": "Structure first. SC shells are galvanized but less thoroughly than the later Carrera 3.2, and the areas that matter are the sills, the bottom rear corners of the door apertures, the A-pillars and windshield surround, the jacking points, the front wing tops, the rear torsion-bar housing and the so-called kidney bowls behind the B-pillars. A leaking windshield seal drains into the pedal box, so lift the carpet. Serious corrosion work runs to five figures. Then establish which car it is. European 201 hp cars, 185 hp 1980 cars and federal cars are three different propositions, and 1981-on cars carry the 17-digit VIN that makes identification straightforward. Ask which timing-chain tensioners are fitted and whether the Carrera pressure-fed conversion has been done, since the answer sets the maintenance horizon. Ask for head-stud history: most cars have either broken studs or receipts for fixing them, and the receipts are worth money. Look for a pop-off valve on the airbox, and check the airbox self-tapping screws are seated rather than standing proud, which indicates a past backfire. Drive it for the gearbox. A 915 that baulks into second when warm, or refuses lower gears, is telling you about linkage, oil and synchros; a properly rebuilt one shifts cleanly, but rebuilds run to four or five figures. Check the clutch has been converted from the rubber-centered original. On a cabriolet, work the hood through its full travel and inspect the frame and rear window.",
 "commonProblems": "The airbox is the fault the SC is known for. A backfire through the Bosch K-Jetronic intake raises pressure inside the plastic airbox and splits it or tears out its self-tapping screws; the resulting vacuum leak stops the engine starting, and a dealer replacement can pass 1,000 dollars before labor. The standard remedy is a spring-loaded pop-off valve fitted to the box to vent the pressure, and cars from 1980 to 1983 with the internal metal manifold are more awkward to modify. Head studs are the second recurring theme. Porsche adopted Dilavar studs from 1977 and issued a technical bulletin covering their fitment; on the SC's aluminum case the failure mode moved from thread pull-out to outright stud breakage, and the symptom is persistent oil weeping at the head joint. Timing-chain tensioners are not oil-pressure fed. The idler arms were revised for 1983 and the problem was only fully resolved by the Carrera-style pressure-fed units of 1984, which are routinely retrofitted. Early rubber-centered clutches fail around 45,000 miles and can take other parts with them. The 915 gearbox balks when worn, and a rebuild is an expensive job. Beyond that: heat exchangers rot, the auxiliary air valve and the K-Jetronic metering head suffer from ethanol in modern fuel, fuel-pump relays fail, and the ceramic fuses corrode.",
 ...
 "sources": [
  {
   "ref": "stuttcars-911sc",
   "title": "Porsche 911 SC (G Series, 1978-1983)",
   "url": "https://www.stuttcars.com/porsche-911-sc-g-series-1978-1983/",
   "publisher": "StuttCars",
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "Gives the 1983 Cabriolet's North American price as $34,450, citing Road & Track. Fetched 2026-09-13 for the US price. Does not give a US list price for the 1978-1982 coupe or Targa."
  },
  {
   ...
   "reliability": "high",
   "notes": "Porsche's own model-year record: 178 hp for MY1978-79, 185 hp for MY1980, 201 hp for MY1981-83; coupe, Targa and Cabriolet from 1983; 15-inch ATS wheels standard; chrome trim in 1978, black anodised from 1979."
  },
  {
   ...
   "sourceType": "manufacturer",
   "reliability": "high",
   "notes": "Source for the 1977 rationalisation to SC and Turbo, the SC taking the Carrera's widened wings, 180 rising to 188 then 201 hp in late 1979 and 1980, cabriolet deliveries from January 1983, and 198,496 G-series cars built 1973-1989."
  },
  {
   ...
   "sourceType": "manufacturer",
   "reliability": "high",
   "notes": "Cabriolet record: four-wheel-drive Turbo-bodied prototype at the 1981 Frankfurt IAA, production premiere at Geneva in March 1982, DM 64,500, three-bow hood of panel elements covering half the roof, structure rated to 152 mph."
  },
  {
   ...
   "reliability": "high",
   "notes": "Period May 1978 road test: 0-60 in 6.5 s, 0-100 in 18 s, over 140 mph, 16-18 mpg against 21-plus for the 2.7, price just under 15,000 pounds, 2,994 cc at 95 x 70.4 mm and 180 hp, replacing the 165 hp 2.7 Lux and 200 hp Carrera 3.0."
  },
  {
   "ref": "pca-model-guide",
   ...
   "reliability": "medium",
   "notes": "Club model guide: SC read as Super Carrera, magnesium-to-aluminum crankcase, US output of 180 then 172 hp from 1980 with a constricted intake manifold, exploding airboxes and the pop-off valve fix, tensioner idler arms revised for 1983 and resolved by Carrera units in 1984, clutches failing near 45,000 miles, Weissach 408, Ferry Porsche 200, SC/RS 20."
  },
  {
   "ref": "stuttcars-sc",
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "Publishes the year-by-year production table by body style and states a total of 60,625; gives Weissach Edition 468 and Ferry Porsche Edition 266; also 0-60 in 6.3 s and curb weight near 2,557 lb."
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "Engine types 930/03, /07, /08, /09 and /10 at 2,994 cc, 95 x 70.4 mm, 8.5:1, aluminum crankcase in place of magnesium, Nikasil barrels, K-Jetronic and torque figures; the same production table with a stated total near 58,000; cabriolet from October 1982, RHD from February 1983; Weissach 400; SC outselling the 928 about twenty to one."
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "States 21 SC/RS built, chassis WP0ZZZ91ZES110001 to 021 invoiced January to April 1984; Type 930/18 with 935 heads and Kugelfischer injection, 255 hp on the road and 270-290 in competition; 2,330 lb; aluminum doors and front lid."
  },
  {
   ...
   "reliability": "medium",
   "notes": "Gives SC production as 58,914 and first-year cabriolet sales as 4,214; states US cars kept the lower-compression 178 hp engine throughout; Weissach M439 at 408 and Ferry Porsche at 200; notes the first use of the designation since the 356 SC and Peter Schutz extending the program."
  },
  {
  ...
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "Establishes the SC as Ernst Fuhrmann's intended last 911 alongside the 924 and 928, the name referencing the final 356 SC, and power tiers of 180 hp with 195 lb-ft, 188 hp and 204 hp with 197 lb-ft at 9.8:1; also head-stud oil leaks, K-Jetronic and fuel-pump relay faults, rust zones and 2024 values of roughly 35,000-90,000 euros."
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "Head-stud history: Dilavar adopted in 1977 under Technical Service Bulletin 7704, and the distinction that pre-1978 magnesium cases suffered thread pull-out while 1978-on aluminum cases shifted the failure to breakage of the studs."
  },
  {
   "ref": "pelican-popoff",
  ...
  },
  {
   ...
   "reliability": "high",
   "notes": "Sold for $52,640 from the Taj Ma Garaj Collection. Chassis WP0EA0916DS171442, 9,230 miles. Catalogue quotes 180 hp for US specification and calls the car one of 1,718 SC cabriolets built for the US market for 1983."
  },
  {
   ...
   "sourceType": "auction-house",
   "reliability": "high",
   "notes": "Sold for $62,720 at Amelia Island in 2025 from the Jim Watson Collection. Chassis WP0ZZZ91ZDS151041, European specification, 2,994 cc SOHC flat six with K-Jetronic quoted at 204 hp."
  }
 ],
 "claims": [
  {
   "section": "history",
   "claimText": "For the 1978 model year Porsche rationalized the 911 range to two models, the 911 SC and the 911 Turbo, retiring the 2.7-liter 911 and 911 Lux and the 3.0-liter Carrera; the SC adopted the Carrera's widened rear wings and three-liter displacement.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
  ...
  {
   "section": "specs",
   "claimText": "The SC engine displaces 2,994 cc from a 3.7 in (95.0 mm) bore and 70.4 mm stroke, with one overhead camshaft per bank, two valves per cylinder, Nikasil-lined cylinders, dry-sump lubrication and Bosch K-Jetronic injection, and replaced the magnesium crankcase used since 1968 with a pressure-cast aluminum unit.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
  ...
  {
   "section": "specs",
   "claimText": "Porsche Classic records output of 178 hp for model years 1978-1979, 185 hp for 1980 and 201 hp for 1981-1983, while Porsche's G-series press kit dates the same two increases to late 1979 and 1980; the 1980 engine went to 8.6:1 compression with revised valves, cam timing, a new oil cooler and a revised tensioner idler arm, and the 1981 engine to 9.8:1.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "porsche-classic-sc",
  ...
  },
  {
   ...
   "conflictNote": "Wikipedia states that United States cars retained the lower-compression 178 hp engine throughout the run, and an RM Sotheby's catalogue for a 1983 US-market cabriolet quotes 180 hp. The Porsche Club of America's model guide states that emissions equipment and a constricted intake manifold reduced US output to 172 hp from 1980. Supercar Nostalgia lists a separate US engine type, 930/07, without quoting a figure. Not resolved by any source consulted here."
  },
  {
   "section": "production",
  ...
  {
   "section": "production",
   "claimText": "The 911 SC/RS (Type 954) was built in 1984 as a Group B homologation evolution with 935 cylinder heads, Kugelfischer mechanical injection, roughly 255 hp on the road and around 2,330 lb, in a run reported as either 20 or 21 cars.",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": [
  ...
  {
   "section": "history",
   "claimText": "The 911 SC Cabriolet was previewed by a four-wheel-drive, Turbo-bodied prototype at the 1981 Frankfurt show, shown in production form at Geneva in March 1982 at $34,450 in the United States and DM 64,500 in Germany, built from October 1982 with right-hand drive from February 1983, and used a three-bow hood of panel elements covering about half the roof area, with the structure rated to 152 mph.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
  ...
  {
   "section": "problems",
   "claimText": "A backfire through the K-Jetronic intake can crack the plastic airbox or pull out its self-tapping screws, producing a vacuum leak that prevents starting; dealer replacement can exceed 1,000 dollars before labor, and the standard remedy is a spring-loaded pop-off valve fitted to the box.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "pelican-popoff",
  ...
  {
   "section": "problems",
   "claimText": "Early rubber-centered clutches fail at around 45,000 miles, the Type 915 gearbox baulks when worn with rebuilds quoted at 4,000 to 10,000 pounds, and the galvanized shell still corrodes at the sills, lower door apertures, A-pillars and windshield surround, jacking points, front wing tops and rear torsion-bar housing, with serious corrosion work put at 7,000 to 10,000 pounds.",
   "confidence": "medium",
   "status": "verified",
   "sourceRefs": [
    "pca-model-guide",
  ...
  {
   "section": "market",
   "claimText": "Auction results for 911 SC cabriolets cluster well below the classic.com extremes: RM Sotheby's sold a 9,230-mile United States car from the Taj Ma Garaj Collection for $52,640, and Gooding sold a European-specification 204 hp example at Amelia Island in 2025 for $62,720.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "rm-tajmagaraj-cabrio",
