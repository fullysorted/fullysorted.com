...
export const seedETypeS1 = {
 ...
 "claims": [
  ...
  {
   "section": "problems",
   "claimText": "Corrosion of the monocoque is the defining fault: floor pans, especially on roadsters, inner and outer sills, door bottoms, rear arches, trunk floor, rear valances, the rear radius arm mountings, and above all the front bulkhead around the engine frame rail mountings. Bonnet seams behind the chrome trim and coupe tailgate seams conceal it well.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "classicsworld-guide",
