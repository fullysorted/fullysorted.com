/**
 * Researched model draft - Nissan Skyline GT-R (R34 (BNR34)).
 * Cross-checked across independent sources; seeded as status='draft' for review.
 */
export const seedSkylineR34 = {
 "slug": "nissan/skyline-gt-r-r34",
 "heroPhoto": "/images/models/nissan-skyline-gt-r-r34.jpg",
 "heroPhotoCredit": "Photo: Mr.choppers, CC BY-SA 3.0, via Wikimedia Commons",
 "make": "Nissan",
 "model": "Skyline GT-R",
 "generation": "R34 (BNR34)",
 "generationCode": "BNR34",
 "trim": null,
 "yearStart": 1999,
 "yearEnd": 2002,
 "bodyStyles": [
 ...
 "engines": [
  "RB26DETT 2.6L (2568cc) twin-turbo DOHC 24v inline-six, 3.4 in (86.0 mm) bore x 73.7mm stroke, individual throttle bodies, ceramic ball-bearing turbochargers; officially rated 276 hp at 6800 rpm and 289 lb-ft at 4400 rpm"
 ],
 ...
 "notableTrims": [
  {
   "name": "V-Spec",
   "note": "Series 1 performance variant with ATTESA E-TS Pro AWD (active electronic LSD), stiffer suspension, added aero and diffuser; the most common R34 GT-R at ~4,192 units."
  },
  {
   "name": "V-Spec II",
  ...
  {
   "name": "M-Spec",
   "note": "Series 2 grand-tourer spec (2001-02) with softer Ripple Control dampers, stiffer rear bar and heated leather; ~366 built. Named after Nissan engineer Kozo Mizuno."
  },
  {
 ...
 "valueTrajectory": "R34 GT-R values rose steadily through the late 2010s and accelerated as the car neared US legality. With rolling 25-year import eligibility beginning in January 2024 (each car qualifying on the 25th anniversary of its build month, so 1999 cars through 2024 and later-build cars into 2025-2027), the largest untapped market opened up, reinforcing strong demand. Combined with fixed, low production, deep pop-culture cachet and JDM-grail status, the trajectory has been firmly upward, with the rarest Nur and Nismo variants leading the appreciation.",
 "overallConfidence": "high",
 "sources": [
  {
   "ref": "hagerty",
   "title": "Your Handy 1999-2002 R34 Nissan Skyline GT-R Buyer's Guide",
   "url": "https://www.hagerty.com/media/market-trends/hagerty-insider/your-handy-1999-2002-r34-nissan-skyline-gt-r-buyers-guide/",
   "publisher": "Hagerty",
   "sourceType": "journalism",
   "reliability": "high",
   "notes": "Values, production breakdown, common problems and cultural context from a leading collector-car authority."
  },
  {
   "ref": "gtrusa",
   "title": "Nissan Skyline GT-R R34 Specifications and Production Information",
   "url": "https://www.gtrusablog.com/2010/02/nissan-skyline-gt-r-r34-production.html",
   "publisher": "Skyline GTR USA",
   "sourceType": "registry",
   "reliability": "medium",
   "notes": "Detailed per-variant production numbers and total (~11,577) plus transmission/engine notes."
  },
  {
   "ref": "supercarnostalgia",
   "title": "Nissan R34 Skyline GT-R Guide",
   "url": "https://supercarnostalgia.com/blog/nissan-r34-skyline-gt-r",
  ...
  {
   "ref": "thedrive",
   "title": "Brace Yourselves: R34 Nissan Skyline GT-Rs Become Legal to Import Next Year",
   "url": "https://www.thedrive.com/news/brace-yourselves-r34-nissan-skyline-gt-rs-become-legal-to-import-next-year",
   "publisher": "The Drive",
   "sourceType": "journalism",
   "reliability": "high",
   "notes": "US 25-year rule mechanics: rolling eligibility by individual build month starting January 2024."
  }
 ],
 "claims": [
  {
   "section": "specs",
   "claimText": "The R34 GT-R uses the 2568cc RB26DETT twin-turbo DOHC inline-six with individual throttle bodies and ceramic ball-bearing turbos.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "supercarnostalgia",
  ...
  {
   "section": "specs",
   "claimText": "Drive is via a Getrag V160 six-speed manual to an ATTESA E-TS (E-TS Pro on V-Spec) all-wheel-drive system with Super-HICAS four-wheel steering.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "gtrusa",
  ...
  {
   "section": "production",
   "claimText": "Approximately 11,577-11,578 BNR34 GT-Rs were built between January 1999 and August 2002.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "gtrusa",
   ...
   "conflictNote": "Sources differ by one to two units (11,577 vs 11,578)."
  },
  {
   "section": "production",
   "claimText": "Per-variant registry figures include base ~3,977, V-Spec ~4,192, V-Spec II ~1,855, M-Spec ~366, V-Spec II Nur ~717 and M-Spec Nur ~285.",
   "confidence": "medium",
   "status": "verified",
   "sourceRefs": [
    "gtrusa",
  ...
  },
  {
   ...
   "conflictNote": "Total build count is variously cited as 19 or 20 completed cars; Hagerty references 19 donor cars while the registry lists 20 Z-tunes."
  },
  {
   "section": "history",
   "claimText": "The R34 shortened the wheelbase and stiffened the body versus the R33 and switched to a Getrag six-speed manual.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "gtrusa",
  ...
  {
   "section": "market",
   "claimText": "As of mid-2025, clean standard and V-Spec cars trade around $130,000-$170,000, with the best exceeding $200,000, and rarer N1/Nur cars $250,000+.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "hagerty"
  ...
  {
   "section": "market",
   "claimText": "US import eligibility under the 25-year rule opened in January 2024, with each car qualifying on the 25th anniversary of its individual build month.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "thedrive"
  ...
  {
   "section": "problems",
   "claimText": "Key ownership concerns are RB26 maintenance and timing-belt failure risk, body rust at arches/rockers/strut towers, difficult parts sourcing, and variable modification quality.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "hagerty"
  ...
  {
   "section": "summary",
   "claimText": "The R34's collector status is driven by pop-culture fame from Gran Turismo, Best Motoring, tuning media and the Fast & Furious films combined with its long-standing forbidden-fruit status in the US.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "hagerty",
