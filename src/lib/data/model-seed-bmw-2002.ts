...
export const seedBmw2002 = {
 ...
 "engines": [
  "1,990 cc M10 SOHC inline-four, iron block and alloy head, single Solex carburetor, 99 hp DIN in the 2002; Car and Driver quoted 114 hp at 5,800 rpm for the 1968 US car",
  "1,990 cc M10 SOHC inline-four, twin Solex carburetors, 118 hp in the 2002 ti, never federalized",
 ...
 "notableTrims": [
  ...
  },
  {
   ...
   "note": "Kugelfischer injection, 130 hp at 5,800 rpm, 1.81 in (46 mm) inlet valves, 10.1 in (256 mm) front discs, boxed rear trailing arms and wider wheels. BMW called it the wolf in sheep's clothing. The strongest sustained demand short of the turbo."
  },
  {
 ...
 "specs": {
  ...
  "chassis": "Unitary steel monocoque, shortened New Class floorpan, 98.4 in (2,500 mm) (98.4 in) wheelbase",
  ...
  "suspension": "MacPherson struts front, semi-trailing arms rear; 0.79 in (20 mm) front and 0.63 in (16 mm) rear anti-roll bars on the turbo",
  "brakes": "Servo front discs and rear drums; 10.1 in (256 mm) front discs on the tii; four-piston front calipers on the turbo",
 ...
 "sources": [
  ...
  },
  {
   ...
   "reliability": "high",
   "notes": "Sold for $140,000, Miami 2025, lot 281. Chassis and engine 4291234, 39,043 miles, Chamonix White, factory five-speed dogleg. Catalog states only 1,660 examples were produced."
  },
  {
   "ref": "rm-mu25-turbo",
   ...
   "sourceType": "auction-house",
   "reliability": "high",
   "notes": "Sold for EUR 126,500, Munich 2025, lot 118. Chassis and engine 4291147, five-speed dogleg, matching numbers; catalog states one of 1,672. Addendum: earlier bodywork removed the original chassis stamp, now restamped."
  }
 ],
 "claims": [
  {
  ...
  {
   "section": "specs",
   "claimText": "The 2002 uses a 1,990 cc M10 single-overhead-camshaft inline-four with an iron block and alloy head, rated by BMW at 99 hp in the carbureted car, 118 hp in the twin-Solex ti, 130 hp at 5,800 rpm in the Kugelfischer-injected tii and 170 hp at 5,800 rpm in the turbocharged M31 version. The tii also took 1.81 in (46 mm) inlet valves against 1.73 in (44 mm), 10.1 in (256 mm) front discs with revised strut housings, boxed rear trailing arms and half-inch wider wheels.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
