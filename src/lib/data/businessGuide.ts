...
export const BUSINESS_GUIDE: GuideChapter[] = [
  /* ─────────────────────────────────────────────────────────── 1 ───── */
  {
    ...
    sections: [
      {
        ...
        body: [
          ...
          "That is the good news and the whole problem at once. The default costs nothing and takes no time, which is why almost everyone starts there — and the default also means there is no line anywhere between you and the work. Your business does not own the polisher; you do. Your business did not agree to that job; you did. And if something goes badly wrong on a car, the claim is not against a company. It is against you, your savings, and in the worst case your house.",
        ],
      },
      {
        ...
        bullets: [
          ...
          { term: "Cost to start", def: "Nothing, unless your city or county wants a business licence — many do." },
    ...
    checklist: [
      ...
      "Check whether your city or county requires a business licence for your trade",
    ],
  },
  ...
  /* ─────────────────────────────────────────────────────────── 2 ───── */
  {
    ...
    sections: [
      ...
      {
        heading: "Licences, permits, and the name on the invoice",
        body: [
        ...
        bullets: [
          { term: "Business licence", def: "Most cities require one for any business operating in their limits, including a one-person mobile operation. It is usually cheap and annual." },
          ...
          { term: "Seller's permit", def: "If you sell parts, products, or materials — not just labour — you likely need one and you likely need to collect sales tax on those items." },
    ...
    checklist: [
      ...
      "Check city/county business licence requirements for your trade",
  ...
  /* ─────────────────────────────────────────────────────────── 3 ───── */
  {
    ...
    checklist: [
      ...
      "Decide your safe-harbour basis — last year's number is usually the easy one",
  ...
  /* ─────────────────────────────────────────────────────────── 5 ───── */
  {
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          { term: "Fixed-price gigs", def: "A productised service with a defined scope and an upfront price, bookable without a quote. Best for repeatable work — a maintenance detail, a pre-purchase inspection, a photo set." },
    ...
    checklist: [
      ...
      "Answer enquiries same-day while the owner is still deciding",
    ],
  },
  ...
  /* ─────────────────────────────────────────────────────────── 7 ───── */
  {
    ...
    sections: [
      {
        ...
        body: [
          ...
          "A written authorisation does not need to be a contract drafted by a lawyer. It needs to say what work is authorised, what it costs, what happens if you find something you did not expect, and when payment is due. An email the client replies 'yes, go ahead' to is vastly better than nothing, and in some states a written estimate before repair work begins is not optional at all.",
        ],
        bullets: [
          ...
          { term: "Timeline", def: "Including what happens if parts do not arrive — which they will not." },
        ...
        callout: {
          kind: "money",
          title: "The photographs are the whole defence",
    ...
    checklist: [
      "Write a one-page work authorisation you can reuse — scope, price, change rule, storage terms",
