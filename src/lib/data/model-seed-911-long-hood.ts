...
export const seed911LongHood = {
 ...
 "engines": [
  ...
  "2,687 cc Type 911/83 air-cooled flat-six, 3.5 in (90 mm) x 70.4 mm, Nikasil-lined cylinders, Bosch mechanical fuel injection, 207 hp at 6,300 rpm, 182 lb-ft at 5,100 rpm; Carrera RS 2.7, 1973"
 ],
 ...
 "specs": {
  ...
  "chassis": "Steel unitary body; wheelbase 87.0 in (2,211 mm) from 1964 to the end of the A-series, 89.3 in (2,268 mm) from the B-series (model year 1969) after the rear wheels were moved 2.2 in (57 mm) aft; Carrera RS rear arches widened 1.65 in (42 mm)",
 ...
 "sources": [
  ...
  {
   "ref": "pfs-1965-911",
   "title": "Model Masterpiece: 1965 Porsche 911",
   "url": "https://www.premierfinancialservices.com/2019/03/05/model-masterpiece-1965-porsche-911/",
   "publisher": "Premier Financial Services",
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "Gives the US introduction price of the 1965 911 as a $6,500 base, set against $4,200 for a Corvette and comparable to a Jaguar E-Type. This is the US-price source for the launch figure."
  },
  {
   "ref": "scm-1968-targa",
 ...
 "claims": [
  {
   "section": "history",
   "claimText": "The car was shown at the Frankfurt Motor Show on 12 September 1963 as the Porsche 901, renamed 911 after Peugeot objected to a three-digit name with a zero in the middle, and entered production on 14 September 1964, listing at $6,500 in the United States and DM 21,900 in Germany.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
  ...
  {
   "section": "specs",
   "claimText": "For the 1969 B-series the rear wheels were moved 2.2 in (57 mm) aft, taking the wheelbase from 87.0 in (2,211 mm) to 89.3 in (2,268 mm); the Porsche Club of America rounds this to 2.5 inches for 1969 and Classic & Sports Car to 2 inches in 1968, the calendar year the B-series began.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "wikipedia-911-classic",
  ...
  {
   "section": "history",
   "claimText": "The Carrera RS 2.7 was developed from May 1972 to homologate the 911 for Group 4, which required 500 cars; it was shown at Paris on 5 October 1972 at DM 34,000 and was not sold new in the US, the 500 were sold by the end of November 1972, and production reached 1,500 by July 1973.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "porsche-newsroom-rs27",
