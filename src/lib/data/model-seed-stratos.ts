...
export const seedStratos = {
 ...
 "claims": [
  ...
  {
   "section": "specs",
   "claimText": "The road car used a 2,418 cc 65-degree Ferrari Dino V6 with twin overhead camshafts per bank, twelve valves and three Weber 40 IDF carburettors, mounted transversely ahead of the rear axle and driving through a five-speed Ferrari transaxle with a 3.824:1 final drive.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "motorsport-1976-test",
