...
export const seed330Gtc = {
 ...
 "engines": [
  "3,967 cc Tipo 209/66 60-degree Colombo V12, single overhead camshaft per bank, wet sump, three twin-choke Weber 40 DCZ/6 or 40 DFI/2 carburettors, claimed 300 hp; peak quoted at 7,000 rpm by Ferrari and RM Sotheby's, at 6,600 rpm by Gooding and Sports Car Digest"
 ],
 ...
 "notableTrims": [
  {
   ...
   "note": "The standard closed car, Geneva March 1966. Pininfarina body on the 275 GTB's 2,400 mm chassis with the 4-liter Tipo 209 V12, rear transaxle and torque tube. The bulk of production and the entry point to a 1960s V12 Ferrari with a genuinely usable cabin."
  },
  {
 ...
 "claims": [
  ...
  {
   "section": "history",
   "claimText": "The 330 GTC combined the 2,400 mm Tipo 592 chassis of the 275 GTB, including its independent rear suspension and rear-mounted five-speed transaxle, with the 4-liter V12 of the late-series 330 GT 2+2, positioning it between the two.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "ferrari-330-gtc",
  ...
  {
   "section": "specs",
   "claimText": "The engine is the 3,967 cc Tipo 209/66 single-overhead-camshaft Colombo V12 with a 77 mm bore and 71 mm stroke, wet sump and three twin-choke Weber 40 DCZ/6 or 40 DFI/2 carburettors, with a claimed 300 hp.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "ferrari-330-gtc",
