...
export const seed330Gtc = {
 ...
 "heroPhoto": "/images/models/ferrari-330-gtc.jpg",
 ...
 "engines": [
  "3,967 cc Tipo 209/66 60-degree Colombo V12, single overhead camshaft per bank, wet sump, three twin-choke Weber 40 DCZ/6 or 40 DFI/2 carburetors, claimed 300 hp; peak quoted at 7,000 rpm by Ferrari and RM Sotheby's, at 6,600 rpm by Gooding and Sports Car Digest"
 ],
 "productionTotal": null,
 "productionNotes": "No two families of source agree, and Ferrari's own heritage page disagrees with itself. The 330 GTC page at ferrari.com states in one paragraph that the model 'remained in production until the end of 1968: 600 were built', and in another that 'a total of 598 examples were produced in both left and right hand drive form, in the chassis number range 08329 to 11613 (excluding prototypes)'. Wikipedia and the Car Collector International buyer's guide repeat 598. RM Sotheby's catalogs use 600 as the headline figure while separately describing individual cars as 'one of 579 examples of the 330 GTC built in left-hand drive between 1966 and 1968'; evo states that only 22 closed cars were configured in right-hand drive, and 579 plus 22 gives 601, which matches none of the published totals exactly. Classic Motorsports, Premier Financial Services, Classic Driver and the Audrain museum all use a round 600. The likeliest explanation is that 598 excludes prototypes and one or more special-bodied chassis while 600 includes them, but no source consulted here says so, and the discrepancy is left open. The open GTS is in the same position: Wikipedia, Sports Car Market, Hagerty, Classic Motorsports and Car Collector International state 100, while RM Sotheby's (chassis 10689, 'the 63rd out of only 99 examples') and Gooding (chassis 9513, 'one of only 99 examples built') both state 99. Ferrari's own 330 GTS page gives no figure at all. The Pininfarina-bodied 'Speciale' coupes are counted differently again: Wikipedia says four, RM Sotheby's catalog for chassis 8727 says six, and supercars.net describes a single car. Given the size of the disagreements, no total is asserted for either body style; a GTC figure of 598 to 600 and a GTS figure of 99 to 100 are the honest ranges. The GTC's chassis range of 08329 to 11613 is Ferrari's own and is not disputed by any source found.",
 "notableTrims": [
  {
   "name": "330 GTC (1966-1968)",
   "note": "The standard closed car, Geneva March 1966. Pininfarina body on the 275 GTB's 94.5 in (2,400 mm) chassis with the 4-liter Tipo 209 V12, rear transaxle and torque tube. The bulk of production and the entry point to a 1960s V12 Ferrari with a genuinely usable cabin."
  },
  {
 ...
 "specs": {
  ...
  "chassis": "Tipo 592 tubular steel chassis, 94.5 in (2,400 mm) (94.5 in) wheelbase, shared with the post-April 1966 275 GTB; Pininfarina steel body, assembled by Pininfarina",
  "engine": "3,967 cc Tipo 209/66 60-degree Colombo V12, alloy block and heads with iron liners, seven-main-bearing crankshaft, chain-driven single overhead camshaft per bank, wet sump, three twin-choke Weber 40 DCZ/6 or 40 DFI/2 carburetors",
  "bore_stroke": "77 mm x 71 mm",
  "compression": "8.8:1 (evo)",
  "power": "300 hp claimed by Ferrari. Peak rpm varies by source: 7,000 rpm (Ferrari, RM Sotheby's), 6,600 rpm (Gooding, Sports Car Digest)",
  ...
  "wheels_tires": "7L x 14 in Borrani wire wheels with 205 x 14 tires as standard",
  "weight": "3,104 lb for the GTS per evo, which describes the spider as 243 lb heavier than the coupe (implying about 2,862 lb for the GTC, a figure evo does not state directly); Classic Motorsports quotes 'nearly 2,900 lb' for the GTC. No factory curb weight located",
  "dimensions": "Length 177.4 in (4,505 mm), width 64.0 in (1,626 mm), height 47.8 in (1,214 mm) (evo)",
 ...
 "sources": [
  ...
  },
  {
   ...
   "reliability": "medium",
   "notes": "Aggregated reference: 598 GTC and 100 GTS; Geneva March 1966 and Paris October 1966 debuts; Tipo 209 engine at 296 hp; shared 275 wheelbase and independent rear suspension; four GTC Speciale by Pininfarina shown at Brussels 1967; one Zagato targa in 1967; replaced by 365 GTC/GTS in 1968."
  },
  {
   "ref": "classic-330-gtc",
  ...
  },
  {
   ...
   "sourceType": "auction-house",
   "reliability": "high",
   "notes": "Sold $967,500, Arizona, January 2022. Chassis 8727, engine 209/0025, 'one of six Speciale examples built on the 330 GTC platform' and 'the fourth of 600 330 GTC examples built'; bought new by Sergio Pininfarina as a design study; dual hood vents, pop-up fog lamps, cloth upholstery."
  },
  {
   ...
   "sourceType": "auction-house",
   "reliability": "high",
   "notes": "Sold $1,600,000 against a $1,750,000 to $2,250,000 estimate, Amelia Island, March 2025. Chassis and engine 9513, 'one of only 99 examples built'; 3,967 cc SOHC Tipo 209/66 V12 at 300 hp at 6,600 rpm; unrestored, 55 years in one ownership, about 39,500 miles; Massini documented."
  },
  {
   ...
   "sourceType": "auction-house",
   "reliability": "high",
   "notes": "Catalog for chassis 10913 (estimate $2.2 to $2.7 million; result not shown on the page). Specification: 3,967 cc Tipo 209/66, three Weber 40 DCZ6, 300 hp at 6,600 rpm, five-speed transaxle, four-wheel Girling discs, independent wishbone and coil suspension. Ex-William F. Harrah, Road & Track cover car December 1969."
  },
  {
  ...
  },
  {
   ...
   "reliability": "medium",
   "notes": "Broad Arrow Villa d'Este, 16-17 May 2026: a matching-numbers 1968 330 GTS, lot 114, realized 1,918,750 euros ($2.23 million) against a 1.5 to 1.7 million euro estimate; sale total 40.8 million euros."
  },
  {
   ...
   "sourceType": "journalism",
   "reliability": "medium",
   "notes": "Summary of the Road & Track period test of the 330 GTS: $15,000 price, 0-60 mph in 6.9 seconds, engine idling at 700 rpm and revving to 7,000, precise strongly synchronised gearbox, light steering, superbly rigid body, adequate air conditioning, brakes not rated favorably."
  },
  {
   "ref": "evo-330-gtc",
  ...
  },
  {
   ...
   "sourceType": "journalism",
   "reliability": "medium",
   "notes": "Describes the GTS as an update of the 275 GTS with a 500 Superfast-inspired nose; 'a genuine 300 hp at 6,600 rpm'; five-speed rear transaxle with torque-tube driveshaft; same tubular chassis as the GTC and very similar to the 275 GTB."
  },
  {
   "ref": "premier-330-gtc",
 ...
 "claims": [
  ...
  {
   "section": "history",
   "claimText": "The 330 GTC combined the 94.5 in (2,400 mm) Tipo 592 chassis of the 275 GTB, including its independent rear suspension and rear-mounted five-speed transaxle, with the 4-liter V12 of the late-series 330 GT 2+2, positioning it between the two.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "ferrari-330-gtc",
  ...
  {
   "section": "specs",
   "claimText": "The engine is the 3,967 cc Tipo 209/66 single-overhead-camshaft Colombo V12 with a 3.0 in (77 mm) bore and 71 mm stroke, wet sump and three twin-choke Weber 40 DCZ/6 or 40 DFI/2 carburetors, with a claimed 300 hp.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "ferrari-330-gtc",
  ...
  {
   "section": "specs",
   "claimText": "The rpm at which the 300 hp peak is quoted and the torque figure both vary by source: 7,000 rpm (Ferrari, RM Sotheby's) against 6,600 rpm (Gooding, Sports Car Digest), and 288 lb-ft at 5,000 rpm (evo, Audrain) against 240 lb-ft at 5,000 rpm (supercars.net).",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": [
    "rm-lf24-8873",
   ...
   "conflictNote": "RM Sotheby's London 2024 catalog quotes 300 hp at 7,000 rpm; Gooding's 2023 and 2025 catalogs and Sports Car Digest quote 300 hp at 6,600 rpm. evo and the Audrain museum give 288 lb-ft of torque; supercars.net gives 240 lb-ft. No manufacturer torque figure was located and the disagreement is not resolved by any source consulted here."
  },
  {
   "section": "production",
  ...
  {
   "section": "production",
   "claimText": "Total 330 GTS production is stated as 100 by most published references and as 99 by RM Sotheby's and Gooding catalog entries; Ferrari's own GTS page gives no figure.",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": [
    "wikipedia-330",
  ...
  },
  {
   ...
   "conflictNote": "Wikipedia and Car Collector International state four Speciale coupes shown at Brussels 1967. RM Sotheby's catalog for chassis 8727 states six built on the 330 GTC platform. supercars.net describes a single car, chassis 9799, shown at Geneva 1967. Not resolved by any source consulted here."
  },
  {
   "section": "history",
   "claimText": "A development car, chassis 06431, cataloged by Gooding as the 275/330 GTC Prototipo, was retained by Ferrari for testing and development through 1966 and is documented by Marcel Massini and factory build sheet copies.",
   "confidence": "medium",
   "status": "verified",
   "sourceRefs": [
  ...
  {
   "section": "specs",
   "claimText": "Published weights are 3,104 lb for the GTS, described by evo as 243 lb heavier than the GTC (implying about 2,862 lb for the coupe), and 'nearly 2,900 lb' for the GTC (Classic Motorsports); no factory curb weight was located and none is asserted as such.",
   "confidence": "medium",
   "status": "verified",
   "sourceRefs": [
    "evo-330-gtc",
  ...
  {
   "section": "history",
   "claimText": "Production ran a little over two years and ended in 1968, when the 4.4-liter 365 GTC and 365 GTS replaced the 330 models with near-identical Pininfarina bodies.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "ferrari-330-gtc",
  ...
  {
   "section": "problems",
   "claimText": "Ownership sources identify valve-guide wear, cooling neglect and carburetor synchronization as the main engine concerns, transaxle whine and a notchy hot gearchange as the signs of a tired rear unit, aging Marelli, dynamo and Lucas electrics, and corrosion in the sills, floors and A-pillars as the structural risk.",
   "confidence": "low",
   "status": "verified",
   "sourceRefs": [
    "cci-330-buyers-guide",
  ...
  {
   "section": "problems",
   "claimText": "Brakes were criticized in period and require the system to be kept in adjustment, hot starting is helped by the auxiliary fuel pump, and factory air conditioning was marginal when new and is described by owners as a matter of maintenance and patience.",
   "confidence": "medium",
   "status": "verified",
   "sourceRefs": [
    "classicmotorsports-330-gtc",
