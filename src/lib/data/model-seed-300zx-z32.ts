...
export const seed300zxZ32 = {
 ...
 "specs": {
  ...
  "wheelbase": "96.5 in (2,451 mm) (96.5 in) for the 2+0; 101.2 in (2,570 mm) quoted by Nissan for the 2+2",
  "dimensions": "169.5 x 70.5 x 49.2 in (4,305 x 1,791 x 1,250 mm) for the 2+0; 178.1 x 70.9 x 49.4 in (4,525 x 1,800 x 1,255 mm) quoted by Nissan for the 2+2",
