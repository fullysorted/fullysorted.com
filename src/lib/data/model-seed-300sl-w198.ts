...
export const seed300SL = {
 ...
 "notableTrims": [
  ...
  },
  {
   ...
   "note": "Factory center-lock option on both bodies. Widely cited as adding a six-figure premium to an otherwise comparable car."
  },
  {
  ...
  },
  {
   ...
   "note": "Dunlop discs all round from March 1961 (chassis 2780 on); aluminum engine block from March 1962 (chassis 3049 on). The last and most usable specification."
  }
 ],
 "specs": {
 ...
 "sources": [
  ...
  },
  {
   ...
   "sourceType": "auction-house",
   "reliability": "high",
   "notes": "2,996 cc SOHC six with Bosch mechanical injection, 220 hp at 5,800 rpm; four-wheel servo drums; original engine per factory build record; sold $1,501,000 against $1.3-1.5m estimate."
  },
  {
  ...
  },
  {
   ...
   "sourceType": "journalism",
   "reliability": "medium",
   "notes": "States 24 aluminum Gullwings built in 1955 (conflicting with the 29 figure elsewhere); 209 lb saving from alloy panels and Plexiglas; alloy cars worth nearly five times steel equivalents, ~$6.7m versus ~$1.4m."
  },
  {
  ...
  },
  {
   ...
   "reliability": "medium",
   "notes": "2,996 cc M198, Bosch mechanical direct injection, dry sump, engine tilted 50 degrees; 240 hp SAE gross at 6,100 rpm; up to 163 mph on the tallest final drive; roadster pivot lowered 87 mm below differential centreline; 290 mm discs March 1961; Hoffman's initial 1,000-car order; production ended February 1963 after 1,858 roadsters."
  },
  {
 ...
 "claims": [
  ...
  {
   "section": "specs",
   "claimText": "The M198 engine is a 2,996 cc single-overhead-cam inline-six using Bosch mechanical direct fuel injection, the first such system fitted to a series-production gasoline car.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "wikipedia-300sl",
  ...
  {
   "section": "specs",
   "claimText": "The engine is canted approximately 50 degrees to the left to lower the hood line, and uses dry-sump lubrication as a consequence of that tilt.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "wikipedia-300sl",
  ...
  },
  {
   ...
   "conflictNote": "Figures differ by measurement standard (DIN versus SAE gross) and by camshaft specification. RM Sotheby's cites 215 hp for a Sonderteile engine, Gooding's catalog 220 hp at 5,800 rpm, and Wikipedia and Supercar Nostalgia 240 hp at 6,100 rpm. No single figure is asserted as canonical."
  },
  {
   "section": "production",
   "claimText": "Coupe production totaled 1,400 cars between August 1954 and May 1957 according to the Gull Wing Group registry, but Sotheby's states 1,408, so no single W198 total is asserted.",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": [
   ...
   "conflictNote": "The Gull Wing Group registry records 1,400 coupes; RM Sotheby's catalog material is consistent with that at 1,371 steel plus 29 alloy. Sotheby's editorial gives 1,408, a difference of eight cars most plausibly explained by the inclusion of prototypes or pre-production examples."
  },
  {
   "section": "production",
   "claimText": "Roadster production totaled 1,858 cars built between May 1957 and February 1963, all left-hand drive.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "gullwing-group-production",
  ...
  {
   "section": "production",
   "claimText": "Twenty-nine coupes were built with all-aluminum bodywork and Plexiglas glazing, saving roughly 209 lb over a steel car.",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": [
    "gullwing-group-production",
  ...
  {
   "section": "specs",
   "claimText": "The Roadster replaced the coupe's high-pivot single-joint swing axle with a low-pivot design, the pivot dropped roughly 3.4 in (87 mm) below the differential centreline and paired with a compensating spring, producing markedly more neutral handling.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "supercarnostalgia-roadster",
  ...
  {
   "section": "specs",
   "claimText": "Roadster sill tubes were reduced in height with bracing added elsewhere to permit conventional doors with wind-down windows; Dunlop discs replaced drums all round in March 1961 and an aluminum engine block arrived in March 1962.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "supercarnostalgia-roadster",
  ...
  {
   "section": "problems",
   "claimText": "Key inspection points are welded or replaced spaceframe tubes indicating accident repair, and corrosion in the headlight buckets, wheel arches, trunk floor, rear roof pillars, areas behind the rear wheels and inner wheel aprons; restoration costs run well into six figures.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
  ...
  {
   "section": "market",
   "claimText": "Returns on ordinary cars have been modest and the market has grown more sensitive to provenance: a 1960 roadster moved from $1.1 million in 2017 to $1,270,000 in 2023, roughly 2.3 percent annualized, while a record non-alloy Gullwing made $3,410,000 in January 2024.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
