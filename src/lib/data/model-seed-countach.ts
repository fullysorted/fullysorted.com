...
export const seedCountach = {
 ...
 "specs": {
  ...
  "chassis": "Full spaceframe of welded round-section steel tubing in 1.18 in (30 mm), 0.98 in (25 mm) and 0.59 in (15 mm) diameters at 0.04 in (1 mm) wall thickness, approximately 198 lb bare; floors, bulkheads and spare-wheel well bonded to the frame",
 ...
 "claims": [
  ...
  {
   "section": "specs",
   "claimText": "The production chassis is a full spaceframe of welded round-section steel tubing in 1.18 in (30 mm), 0.98 in (25 mm) and 0.59 in (15 mm) diameters at 0.04 in (1 mm) wall thickness, weighing approximately 198 lb bare, with floors, bulkheads and the spare-wheel well bonded to it.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "wikipedia-countach",
  ...
  {
   "section": "specs",
   "claimText": "As tested by Motor Sport in July 1977, the LP400 gave 375 hp DIN at 8,000 rpm and 267 lb-ft at 5,500 rpm from 3,929 cc on an 3.2 in (82 mm) bore and 62 mm stroke at 10.5:1 compression, with 43/57 weight distribution, 10.51-inch ventilated discs and Girling aluminum calipers, and a UK list price of 29,950 pounds.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "motorsport-1977"
