...
export const seedMiura = {
 ...
 "engines": [
  "3,929 cc Bizzarrini-derived 60-degree quad-cam V12, transverse, four triple-choke Weber carburettors; 345 hp at 7,000 rpm (P400) per Lamborghini, 345 hp quoted elsewhere",
  ...
  "3,929 cc V12 with revised cam timing and larger carburettors; 380 hp at 7,850 rpm (P400 SV), 375-380 hp quoted elsewhere. Later SV engines use a split sump separating gearbox oil from engine oil"
 ],
 ...
 "specs": {
  ...
  "chassis": "Folded and welded sheet-steel platform drilled for lightness, about 265 lb; wall thickness quoted between 0.8 mm and 1.0 mm by source and build date",
 ...
 "claims": [
  ...
  {
   "section": "production",
   "claimText": "The P400 S was the most numerous variant at 338 cars built between December 1968 and March 1971, of which 21 were right-hand drive; it gained reshaped combustion chambers, inlet ports enlarged from 28 mm to 30 mm, higher-lift camshafts and compression raised from 9.5:1 to 10.7:1 for 365 hp at 7,700 rpm, with ventilated discs introduced partway through the run.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "lamborghini-heritage-miura",
  ...
  {
   "section": "specs",
   "claimText": "The P400 SV of 1971 widened the rear track to about 1,540 mm with longer rear wishbones, fitted nine-inch rear rims under flared arches, deleted the headlamp eyelashes and stiffened the structure, and quoted 380 hp at 7,850 rpm with 295 lb-ft at 5,750 rpm.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "lamborghini-heritage-miura",
