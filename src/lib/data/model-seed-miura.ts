...
export const seedMiura = {
 ...
 "yearEnd": 1973,
 "bodyStyles": [
  "2-door berlinetta by Bertone, aluminum and steel panels over a folded and welded sheet-steel platform",
  "2-door open show car (Bertone Miura Roadster, one built, never a production body style)"
 ],
 "engines": [
  "3,929 cc Bizzarrini-derived 60-degree quad-cam V12, transverse, four triple-choke Weber carburetors; 345 hp at 7,000 rpm (P400) per Lamborghini, 345 hp quoted elsewhere",
  "3,929 cc V12 with enlarged inlet ports, higher-lift camshafts and raised compression; 365 hp at 7,700 rpm (P400 S), 365 hp quoted elsewhere",
  "3,929 cc V12 with revised cam timing and larger carburetors; 380 hp at 7,850 rpm (P400 SV), 375-380 hp quoted elsewhere. Later SV engines use a split sump separating gearbox oil from engine oil"
 ],
 ...
 "notableTrims": [
  {
   "name": "P400 (1966-1969)",
   "note": "The original series at 345 hp, with the thinnest chassis steel and the lightest cars of the run. Lamborghini states 265 built, other sources 274 or 275. Many were later rebuilt to S or SV specification, which makes a documented, unconverted P400 scarcer than the production figure suggests."
  },
  {
   "name": "P400 S (1968-1971)",
   "note": "The most numerous version at 338 cars, December 1968 to March 1971, of which 21 were right-hand drive. Enlarged inlet ports, higher-lift cams and raised compression for 365 hp, plus a full-length console, electric windows and optional air conditioning. Ventilated discs arrived during the run."
  },
  {
 ...
 "specs": {
  ...
  "chassis": "Folded and welded sheet-steel platform drilled for lightness, about 265 lb; wall thickness quoted between 0.03 in (0.8 mm) and 0.04 in (1.0 mm) by source and build date",
  "body": "Bertone coachwork by Marcello Gandini; aluminum panels with steel structure, front and rear clamshells hinged at the extremities",
  ...
  "induction": "Four triple-choke Weber carburetors, twelve throttle valves",
  ...
  "power": "345 hp at 7,000 rpm (P400), 365 hp at 7,700 rpm (S), 380 hp at 7,850 rpm (SV) per Lamborghini; independent sources quote 345, 365 and 375-380 hp",
  "torque": "About 271 lb-ft (P400), 287 lb-ft at 5,500 rpm (S), 295 lb-ft / 295 lb-ft at 5,750 rpm (SV)",
  ...
  "wheels_tires": "Campagnolo cast magnesium; SV rear rims 9 in wide with Pirelli Cinturato, original P400 fitment Pirelli Cinturato 205VR15 (CN72)",
  "weight": "Sources differ widely: Supercars.net gives 2,903 lb curb for the SV, Goodwood 2,524 lb; the bare chassis is quoted at about 265 lb",
 ...
 "sources": [
  {
   ...
   "reliability": "high",
   "notes": "Factory record: Geneva 1966 debut, Bertone body, transverse V12; 345 hp at 7,000 rpm (P400), 370 at 7,700 (S), 385 at 7,850 (SV); 265 P400, 338 S, 150 SV, four SVJ and a Spyder; credits the SV with wider tires, flared arches, a stronger chassis and independent gearbox lubrication."
  },
  {
   "ref": "wikipedia-miura",
  ...
  },
  {
   ...
   "reliability": "medium",
   "notes": "Bare P400 GT chassis at Turin late 1965, bodied prototype at Geneva March 1966; Dallara concept, Stanzani chassis, Gandini body; Mini-derived shared lubrication; 350 hp claimed against roughly 320 actual, 180 mph against a realistic 170; front-end lift above 150 mph with alarming wandering, inadequate brakes and chassis flex, only partially cured by the SV; seventeen orders at the 1966 Monaco GP."
  },
  {
  ...
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "Sheet-steel chassis of 0.8 mm wall thickness punched for lightness, about 265 lb; engine, transmission and differential in one housing on a single lubrication system, with engine oil contaminated by gearbox debris; counter-rotating crank, seven main bearings, 60-degree vee; states 763 built."
  },
  {
   "ref": "supercars-sv",
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "148 SVs from chassis 4758, 1971-1973; first 52 shared engine and gearbox oil, roughly 96 later cars split; longer rear wishbones adding about 1.5 in, rear track 1,540 mm against 1,410 mm front; 385 hp at 7,850 rpm, 295 lb-ft at 5,750; 2,903 lb curb; eyelashes replaced by smooth surrounds."
  },
  {
   "ref": "supercars-svj",
  ...
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "338 S built of which 21 right-hand drive, December 1968 to March 1971; inlet ports enlarged 28 mm to 30 mm, high-lift cams, compression raised 9.5:1 to 10.7:1; 370 hp at 7,700 rpm and 287 lb-ft at 5,500 against the P400's 350 hp and 271 lb-ft."
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "Jota begun by Wallace in 1970 under Stanzani, completed by 1972; light-alloy frame, adjustable suspension, skirts and faired headlamps; about 551 lb saved for roughly 1,940 lb; 440 hp at 8,500 rpm; sold through an Italian dealer in 1972 and destroyed shortly afterwards."
  },
  {
 ...
 "claims": [
  ...
  {
   "section": "specs",
   "claimText": "The engine is a 3,929 cc 60-degree quad-cam V12 laid out by Giotto Bizzarrini, mounted transversely with seven main bearings, a counter-rotating crankshaft and four triple-choke Weber carburetors; on the P400, P400 S and earliest SVs it was cast in a common housing with the gearbox and final drive and shared one supply of oil with them, a Mini-derived idea that let gearbox debris circulate through the engine. The platform is folded and welded sheet steel of about 265 lb, quoted at between 0.03 in (0.8 mm) and 0.04 in (1.0 mm) gauge.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "wikipedia-miura",
  ...
  {
   "section": "production",
   "claimText": "The P400 S was the most numerous variant at 338 cars built between December 1968 and March 1971, of which 21 were right-hand drive; it gained reshaped combustion chambers, inlet ports enlarged from 1.10 in (28 mm) to 1.18 in (30 mm), higher-lift camshafts and compression raised from 9.5:1 to 10.7:1 for 365 hp at 7,700 rpm, with ventilated discs introduced partway through the run.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "lamborghini-heritage-miura",
  ...
  {
   "section": "specs",
   "claimText": "The P400 SV of 1971 widened the rear track to about 60.6 in (1,540 mm) with longer rear wishbones, fitted nine-inch rear rims under flared arches, deleted the headlamp eyelashes and stiffened the structure, and quoted 380 hp at 7,850 rpm with 295 lb-ft at 5,750 rpm.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "lamborghini-heritage-miura",
  ...
  {
   "section": "history",
   "claimText": "Bob Wallace built a single Jota from 1970 with a light-alloy frame, lightweight panels, relocated fuel tanks and a reworked V12 of around 440 hp; it was sold to a private buyer and destroyed in a crash near Brescia, and the sources agree on neither the year nor the figures.",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": [
    "wikipedia-miura",
