...
export const seedAmphicar770 = {
 ...
 "notableTrims": [
  {
   "name": "Model 770",
   "note": "The only model sold; the '770' name denotes ~7 mph (knots) on water and ~70 mph on land."
  },
  {
   "name": "Export/US-spec",
   "note": "The overwhelming majority of production was left-hand drive and shipped to the US market via the Amphicar Corporation."
  }
 ],
 "specs": {
 ...
 "valueTrajectory": "Values climbed steadily as the Amphicar became a viral, feel-good icon, and have plateaued at a healthy level in the mid-2020s - solid usable cars generally in the $60k - $95k window, with the very best floating, well-documented examples pushing toward or beyond $90k and projects far below. The mid-2026 benchmark shows mild softening rather than a boom, suggesting a mature, enthusiast-driven market. Because the appeal is experiential (you can drive it into the water), running and seaworthy cars will continue to command a clear premium over static restorations or projects.",
 "overallConfidence": "high",
 "sources": [
  {
   "ref": "wikipedia",
   "title": "Amphicar",
   "url": "https://en.wikipedia.org/wiki/Amphicar",
   "publisher": "Wikipedia",
   "sourceType": "reference-book",
   "reliability": "medium",
   "notes": "General encyclopedia; corroborates production total 3,878, 97 RHD, Trippel, Quandt Group, engine and dimensions."
  },
  {
   "ref": "heacock",
   "title": "1964 Amphicar Model 770",
   "url": "https://heacockclassic.com/articles/1964-amphicar-770/",
   "publisher": "Heacock Classic Insurance",
   "sourceType": "journalism",
   "reliability": "medium",
   "notes": "Collector-car insurer profile; cites 3,878 total, 3,046 US imports, ~832 European sales, dual transmissions, tallest fins claim."
  },
  {
   "ref": "lanemotor",
   ...
   "sourceType": "reference-book",
   "reliability": "high",
   "notes": "Museum collection page; confirms designer, Triumph Herald engine, twin props, land/water drive, front wheels as rudders."
  },
  {
   "ref": "silodrome",
   "title": "The Amphicar 770: A Vintage Car That's Also A Boat",
   "url": "https://silodrome.com/amphicar-770/",
   "publisher": "Silodrome",
   "sourceType": "journalism",
   "reliability": "medium",
   "notes": "Confirms '770' = 7 mph water / 70 mph land, 3,878 built, LBJ prank, selectable gearbox (wheels/props/both), Schwimmwagen lineage."
  },
  {
   "ref": "classiccom",
   "title": "Amphicar Model 770 Market",
   "url": "https://www.classic.com/m/amphicar/model-770/",
  ...
  {
   "ref": "historyfacts",
   "title": "LBJ would prank guests at his ranch by driving his car into the lake",
   "url": "https://historyfacts.com/famous-figures/fact/lbj-amphicar-prank/",
   "publisher": "History Facts",
   "sourceType": "journalism",
   "reliability": "medium",
   "notes": "Details the LBJ 'brakes don't work' lake prank at the Stonewall, TX ranch and the Califano anecdote."
  }
 ],
 "claims": [
  {
   "section": "history",
   "claimText": "The Amphicar 770 was designed by German engineer Hans Trippel and built by the Quandt Group from 1961 to 1968, making it the first and most successful mass-produced civilian amphibious car.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "wikipedia",
  ...
  {
   "section": "specs",
   "claimText": "The car had two gearboxes - a 4-speed manual for the road and a separate 2-speed marine unit for the propellers - with a selector allowing wheels-only, propellers-only, or both together.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "silodrome",
  ...
  {
   "section": "specs",
   "claimText": "The '770' name reflects performance of roughly 7 (knots/mph) on water and about 70 mph on land; the sometimes-cited '10/10' nickname is not well documented in the reputable sources reviewed.",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": [
    "silodrome",
   ...
   "conflictNote": "Multiple reputable sources consistently explain the name as 7 (water) / 70 (land). The '10/10' framing (~10 mph water / ~70 mph land) does not appear in the primary sources found; water speed is documented as ~7 knots/6.5 mph, so '10 mph on water' is at the optimistic end and the '10/10' label is treated as unverified."
  },
  {
   "section": "production",
   "claimText": "Approximately 3,878 Amphicars were built in total, with only about 97 right-hand-drive.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "wikipedia",
  ...
  {
   "section": "production",
   "claimText": "The overwhelming majority of production was exported to the United States (the '70 into the 770' focus); Heacock cites 3,046 US imports versus ~832 European sales, while other accounts say roughly 3,700 reached the US.",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": [
    "heacock",
   ...
   "conflictNote": "US import figures differ by source (3,046 per Heacock vs ~3,700 in some accounts); all agree the US was the dominant market."
  },
  {
   "section": "production",
   "claimText": "Estimates of surviving Amphicars range from 'several hundred' to around 500 still operable today.",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": [
    "silodrome",
   ...
   "conflictNote": "Survivor counts are estimates only; figures cited range from a few hundred to ~500 operable, with no authoritative registry total confirmed."
  },
  {
   "section": "history",
   "claimText": "President Lyndon B. Johnson owned an Amphicar and pranked guests at his Texas ranch by feigning brake failure and driving into the lake, shouting that the brakes wouldn't hold.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "historyfacts",
  ...
  {
   "section": "specs",
   "claimText": "Top speed was about 70 mph on land and roughly 7 knots on water, with the front wheels acting as rudimentary rudders.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "wikipedia",
  ...
  {
   "section": "problems",
   "claimText": "Corrosion is the primary enemy because the steel unibody doubles as the boat hull; running, water-tested examples command a clear premium over projects.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "heacock",
