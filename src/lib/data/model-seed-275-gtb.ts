...
export const seed275Gtb = {
 ...
 "claims": [
  ...
  {
   "section": "history",
   "claimText": "Sources disagree on when the torque tube was introduced: Wikipedia and Sports Car Market place it within the two-cam Series II run, while Classic & Sports Car attributes the 75 mm torque tube to the 275 GTB/4.",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": [
    "wikipedia-275",
