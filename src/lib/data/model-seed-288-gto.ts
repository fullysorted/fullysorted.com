...
export const seed288Gto = {
 ...
 "claims": [
  ...
  {
   "section": "specs",
   "claimText": "The GTO was the first Ferrari production road car with a longitudinally mounted V8 and the first with twin turbochargers; turning the engine lengthways with the gearbox behind the differential required a 2,450 mm wheelbase, 110 mm longer than the 308 GTB.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "ferrari-gto",
