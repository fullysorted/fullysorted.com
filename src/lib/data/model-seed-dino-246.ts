...
export const seedDino246 = {
 ...
 "engines": [
  "2,418 cc (quoted by some sources as 2,419.2 cc) Dino 65-degree V6, transversely mid-mounted, cast-iron block with alloy heads, twin overhead camshafts per bank, two valves per cylinder, three Weber carburetors, 9.0:1 compression, 192 hp at 7,600 rpm",
 ...
 "notableTrims": [
  ...
  },
  {
   ...
   "note": "Late 1971 to 1974 and much the largest series, with the most developed specification: further gearbox revisions and upgraded Weber carburetors. Production is described as having reached three cars a day. This is where the sources disagree most sharply on volume."
  },
  {
 ...
 "specs": {
  ...
  "engine": "2,418 cc Dino 65-degree V6, cast-iron block with alloy heads, chain-driven twin overhead camshafts per bank, two valves per cylinder, three Weber carburetors, Magneti Marelli Dinoplex ignition",
  "bore_stroke": "92.5 mm x 60 mm (206 GT: 3.4 in (86 mm) x 57 mm)",
  "compression": "9.0:1",
  ...
  "wheelbase": "92.1 in (2,340 mm), lengthened by 2.4 in (60 mm) over the 206 GT; Wikipedia gives 90.2 in (2,290 mm) for the 206",
 ...
 "claims": [
  ...
  {
   "section": "production",
   "claimText": "Approximately 152 Dino 206 GTs were built between 1967 and 1969, all left-hand drive, on a body that was aluminum throughout - a Pininfarina design credited to Aldo Brovarone and Leonardo Fioravanti, built by Scaglietti in Modena - over a wheelbase 2.4 in (60 mm) shorter than the 246's; Ferrari's own model page gives approximately 150.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "ferrari-206-gt",
  ...
  },
  {
   ...
   "conflictNote": "Wikipedia, Supercar Nostalgia and Hagerty each state 507 M-series cars. classic.com states 506. RM Sotheby's catalog for chassis 01406 states only 497 were produced. The difference is not explained by any source consulted here and is not resolved."
  },
  {
   "section": "production",
