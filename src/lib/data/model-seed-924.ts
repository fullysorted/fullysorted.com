...
export const seed924 = {
 ...
 "claims": [
  ...
  {
   "section": "history",
   "claimText": "The body was designed by Harm Lagaaij under chief designer Anatole Lapine around a package already fixed by VW's parts choices; the pre-series car was shown at La Grande-Motte in November 1975 and the base price at launch was DM 23,240.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "porsche-newsroom-new-direction",
