...
**Confirm it really is an M3 — and the right one.** Many five-lug "basket-weave" BMW wheels look similar but use a different offset (factory M3 +24mm; special editions +27mm). Verify Evolution / Sport Evo / Cecotto authenticity against documentation, plaques and colors; values diverge sharply.
