 ...
 * power of the Sport Evolution, quoted as both 235 hp and 235 hp), the
...
export const seedE30M3 = {
  ...
  engines: [
    'S14B23 2.3L DOHC inline-four (192-194 hp standard; 212 hp Evolution II / late M3)',
    'S14B25 2.5L DOHC inline-four (Sport Evolution, 235 hp / 235 hp)',
  ...
  notableTrims: [
    { name: 'M3 (standard / "base")', note: 'The homologation road car. Euro spec made ~192-194 hp from the 2.3L S14; a catalyzed variant for tighter-emissions markets made ~192 hp. Largest single cohort of the run.' },
    { name: 'M3 Evolution ("EVO1", 1987)', note: 'Homologation step: revised cylinder head (an "E" stamp), unchanged ~194 hp. 505 built Mar - May 1987. Not sold in the U.S.' },
    { name: 'M3 Evolution II ("EVO2", 1988)', note: '217 hp, lighter decklid, thinner glass, BBS 16in wheels, brake ducts, more aggressive aero. 501 built. Not sold in the U.S.' },
    { name: 'M3 Sport Evolution ("EVO3" / "Evo III", 1990)', note: 'The ultimate E30 M3: 2.5L S14, ~235 hp, adjustable front splitter and rear wing, lighter, lower, only Brilliant Red or Glossy Black. 600 built - the most collectible variant.' },
    { name: 'M3 Cecotto / Ravaglia (1989)', note: 'Named for works drivers Johnny Cecotto and Roberto Ravaglia. EVO2-style body kit, special colors, 212 hp late-spec engine. Commonly cited as 505 cars combined (≈480 Cecotto + 25 UK-market Ravaglia).' },
    { name: 'M3 Europameister (1988)', note: 'Celebrated the 1988 European Touring Car title. 148 cars in Macao Blue with extended gray leather and a Ravaglia-signed plaque.' },
  ...
  specs: {
    ...
    'Power (standard)': '192-194 hp @ ~6,750 rpm; 212 hp on late/Evolution cars',
    'Engine (Sport Evo)': 'S14B25, 2,467 cc - 235 hp @ 7,000 rpm',
    'Torque (standard)': '~170 lb-ft (230 N·m)',
...
Rather than start from one of BMW's straight-sixes, engineer Paul Rosche built the S14 around the M10 four-cylinder block and crowned it with a twin-cam 16-valve aluminum head derived from the M88 (the engine of the M1 supercar, later the S38 of the original M5). In effect it is that motorsport six with two cylinders removed - lighter over the nose and happy to rev. With individual throttle bodies and solid lifters it produced about 192-194 hp at launch (a catalyzed version for stricter markets made ~192 hp / 192 hp), rising to 212 hp on later and Cecotto/Ravaglia cars. The U.S. always received a catalyzed car.
...
Because homologation rewards continuous development, the M3 spawned a family of "Evolution" specials, each built in small numbers to legalize new parts for racing:

- **Evolution ("EVO1", 1987):** a revised head, unchanged power - 505 built.
- **Evolution II ("EVO2", 1988):** 217 hp, lighter decklid, thinner glass, brake ducts, BBS wheels - 501 built.
- **Sport Evolution ("EVO3", 1990):** the apex car. The S14 grew to 2.5 liters and ~235 hp, with an adjustable front splitter and rear wing, lower ride height, thinner glass and a lighter trunk. Just 600 were built, in only Brilliant Red or Glossy Black.
...
The E30 M3 became the most successful touring car of its generation, winning the DTM, the WTCC, the ETCC and championships in Italy, Australia, Japan and elsewhere across the late 1980s and early 1990s. Production ended in 1991. It was replaced by the very different six-cylinder E36 M3 in 1992 - a faster, more grown-up car, but one that traded the E30's raw, homologation-special purity for everyday usability, which is a big part of why the original is so revered today.`,
  ...
  marketNotes: `For years the E30 M3 was a relatively attainable enthusiast car, then it became one of the defining modern-classic success stories. Hagerty's buyer's guide notes the model began appreciating sharply in 2013-2014 and ran hard through about 2018, with median #2 (excellent) values up roughly 324 percent over that stretch before cooling after 2019. By the time of that guide, multiple E30 M3s had crossed Bring a Trailer above US$100,000, including an ultra-low-mileage example at a quarter-million dollars, while Hagerty's median quoted value sat around US$51k.
...
**Rust is the number-one killer.** The shell is a regular-E30 base with period-typical corrosion protection. Check the rear wheel arches, sills/rockers (plastic covers hide decay), floorpans and the battery tray, sunroof drains, the bonded windshield and rear-screen corners, around the taillights and license-plate lights, and the rear subframe and shock towers. Sound metal there usually means a sound car.

**Confirm it really is an M3 - and the right one.** Many five-lug "basket-weave" BMW wheels look similar but use a different offset (factory M3 +0.94 in (24 mm); special editions +1.06 in (27 mm)). Verify Evolution / Sport Evo / Cecotto authenticity against documentation, plaques and colors; values diverge sharply.
...
**Parts cost and availability.** Many M3-specific parts (bodywork, glass, interior trim, wheels, S14 internals) are bespoke to this car and not shared with the ordinary E30, so they are expensive and sometimes hard to source - missing or incorrect parts meaningfully affect value and restoration cost.`,
  ...
  sources: [
    ...
    },
    {
      ...
      sourceType: 'manufacturer',
      reliability: 'high',
      notes: 'Manufacturer model description for the Sport Evolution (2.5L, 600 units, ~235 hp).',
    },
    {
      ref: 'wikipedia-m3',
      title: 'BMW M3',
  ...
  claims: [
    ...
    },
    {
      section: 'specs',
      claimText:
        'The S14 engine uses the M10 four-cylinder block with a DOHC 16-valve head derived from the M88/S38 six (the M1/M5 engine with two cylinders removed), designed by Paul Rosche; standard cars made ~192-194 hp, rising to 212 hp on later cars.',
      confidence: 'high',
      status: 'verified',
    ...
    },
    {
      section: 'specs',
      claimText:
        'The Sport Evolution\'s 2.5-liter S14 is rated at 235 hp / 235 hp at 7,000 rpm.',
      confidence: 'high',
      status: 'disputed',
      sourceRefs: ['bmw-classic-sportevo', 'wikipedia-m3', 'hagerty'],
      conflictNote:
        'This is a units artifact rather than a real disagreement: 235 hp equals 235 hp (metric horsepower) and 235 hp (SAE/imperial), so BMW Group Classic and Wikipedia cite "235 hp / 235 hp" while Hagerty writes "235 horsepower." Both describe the same engine output. Flagged so the two numbers aren\'t mistaken for conflicting power figures.',
    },
    {
      section: 'production',
      claimText:
    ...
    },
    {
      section: 'market',
      claimText:
        'E30 M3 values rose sharply from ~2013-2014 through ~2018 (Hagerty cites ~324 percent growth in median #2 values) before cooling after 2019, with top cars now six-figure and the Sport Evolution at the apex.',
      confidence: 'medium',
      status: 'unverified',
      sourceRefs: ['hagerty'],
      conflictNote:
