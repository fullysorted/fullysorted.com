...
export const seed365Gtb4Daytona = {
 ...
 "engines": [
  "4,390 cc Tipo 251 60-degree V12, all-alloy, twin overhead camshafts per bank, two valves per cylinder, six Weber 40 DCN 20/21 twin-choke carburetors, dry sump, 9.3:1 compression, 352 hp at 7,500 rpm and 318 lb-ft at 5,500 rpm (European specification, factory claim)",
  "4,390 cc Tipo 251 V12 to US specification: 8.8:1 compression, Weber 40 DCN 21A carburetors, revised exhaust with central muffler and electronic ignition; output not separately quoted by the sources consulted",
  "4,390 cc Tipo 251 V12 in Competizione tune: quoted between roughly 400 and 450 hp depending on series, with the Series III cars stated at 450 hp at 8,500 rpm"
 ],
 "productionTotal": null,
 "productionNotes": "The sources consulted agree on the berlinetta but not on the spider, and they do not agree on how the competition cars should be counted, so no single total is asserted. For the 365 GTB/4 berlinetta the figure of 1,284 road cars is stated independently by Wikipedia, Supercar Nostalgia, Petrolicious, classic.com and DK Engineering. Tom Yang's buyer's guide is internally inconsistent: its text says production 'ran for 1284 GTB's (plus 19 competition Berlinetta's)', while its specification table lists 1,383 for the 365 GTB/4; the 1,383 figure is not supported elsewhere and is likely a table error rather than a competing count. For the 365 GTS/4 spider Ferrari's own model page states 'a total of 122 spider examples were built in the chassis number range 14365 to 17073', and Wikipedia, classic.com, Petrolicious and Tom Yang also say 122. Against that, Supercar Nostalgia gives '121 production Spyders (seven of which were right-hand drive)' plus prototypes, RM Sotheby's Monterey 2026 catalog describes chassis 14901 as 'the 37th of 121 Daytona Spiders produced', and Motor Sport's 2020 buying guide also says 121. The most likely explanation is whether a prototype is counted, but no source says so explicitly and the point is left unresolved. Right-hand-drive berlinettas are variously given as 149 (Supercar Nostalgia), 156 (Wikipedia) and 158 (RM Sotheby's London 2025, Motor Sport, DK Engineering). Competition cars are given as 15 official factory builds in three series of five (Wikipedia, Gooding Christie's, RM Sotheby's), 18 race-prepared berlinettas (Ferrari's own Competizione page), 19 (Tom Yang) or 24 completed including non-factory builds (RM Sotheby's). The widely repeated aggregate of 1,406 cars, which Wikipedia and classic.com both use, is therefore 1,284 plus 122 and does not include the competition cars; it is reproduced here as a commonly cited figure, not as a verified one. Around 400 berlinettas with the early Plexiglas nose is a Supercar Nostalgia figure not corroborated elsewhere.",
 "notableTrims": [
  {
   "name": "365 GTB/4 Plexiglas nose (1968-1971)",
   "note": "Early European cars carried four headlamps behind a full-width Perspex panel with a satin-finish aluminum nose band. Supercar Nostalgia puts the count at around 400, uncorroborated; pop-up lamps arrived gradually between chassis 13800 and 14200 to satisfy US lighting rules. Early cars command a premium in some markets."
  },
  {
   "name": "365 GTB/4 pop-up headlamp berlinetta (1971-1973)",
   "note": "The bulk of production. Retractable lamps, body-color nose panel from late 1971 and, from chassis 15701, steel rather than aluminum doors. Most cars offered today are of this specification and it is the benchmark against which the market prices everything else."
  },
  {
   "name": "365 GTB/4 US specification",
   "note": "Lower 8.8:1 compression, different Weber jetting, central muffler, electronic ignition, side marker lamps and, on late cars, side-impact bars in steel doors. Heavier than European cars and often carrying miles-reading instruments and factory air conditioning; a well-kept US car is not a lesser car, but a European-specification engine is worth confirming rather than assuming."
  },
  {
   "name": "365 GTB/4 right-hand drive",
   "note": "Between 149 and 158 berlinettas depending on the source, most of them delivered to the UK. Right-hand-drive cars sell materially below comparable left-hand-drive examples, which is the usual RHD discount rather than a comment on the cars."
  },
  {
   "name": "365 GTS/4 Daytona Spider",
   "note": "Shown at Frankfurt in 1969 and built from 1971 to 1973 with steel rather than glassfiber floors, twin 49-liter tanks and a folding canvas roof. Either 121 or 122 were built, seven of them right-hand drive. As of September 2026 classic.com's benchmark for the spider is roughly four times that of the berlinetta."
  },
  {
   "name": "365 GTB/4 Competizione (Series I, II and III)",
   "note": "Fifteen officially recognized factory competition cars in three series of five, built for Group 4 with lightened bodies and engines tuned to between roughly 400 and 450 hp, plus further privateer and later conversions that push some counts to 24. Class winners at Le Mans in 1972, 1973 and 1974. Gooding Christie's sold Series III chassis 16407 for $8,145,000 at Pebble Beach in August 2025, a record for the model."
  },
  {
 ...
 "specs": {
  ...
  "chassis": "Tipo 605 welded tubular steel frame with glassfiber inner tub and floors on the berlinetta, steel floors on the spider; steel body panels by Scaglietti with aluminum doors, hood and trunk lid on earlier cars",
  "engine": "4,390 cc Tipo 251 60-degree V12, all-alloy, twin overhead camshafts per bank, two valves per cylinder, dry sump, six Weber 40 DCN twin-choke carburetors",
  "bore_stroke": "81 mm x 71 mm",
  "compression": "9.3:1 European; 8.8:1 US specification",
  "power": "352 hp at 7,500 rpm claimed for European cars (some sources quote 347 hp SAE); US output not separately stated by the sources consulted",
  "torque": "318 lb-ft at 5,500 rpm claimed; Supercars.net quotes 319 lb-ft at 5,000 rpm",
  ...
  "wheels_tires": "15 x 7.5 in Cromodora cast alloy center-lock five-spokes (Borrani wires optional), 215/70 VR15 tires",
  "weight": "Sources disagree: 2,822 lb (Supercar Nostalgia, European car), 3,472 lb for US-specification cars (Supercar Nostalgia), 3,500 lb dry (Mel Nichols period test), 3,600 lb curb (Supercars.net). Treat any single figure with caution",
  "top_speed": "174 mph claimed; Autocar recorded 174 mph in period per Motor Sport, and Mel Nichols' test used the same figure",
  ...
  "wheelbase": "94.5 in (2,400 mm) (94.5 in); tracks 56.6 in front, 56.1 in rear",
  "dimensions": "174.2 in (4,425 mm) long, 69.3 in (1,760 mm) wide, 49.0 in (1,245 mm) high",
  "fuel_capacity": "128 liters in two 64-liter tanks (berlinetta); 98 liters in twin 49-liter tanks (spider)",
 ...
 "summary": "The Ferrari 365 GTB/4 (1968-1973) was the last of Maranello's front-engined two-seat V12 berlinettas in the line that ran back to the 166, and the car that closed that line at very high speed. Shown at the Paris Salon in October 1968 as the replacement for the 275 GTB/4, it took the Colombo V12 out to 4,390 cc with four overhead camshafts, six Weber carburetors and a claimed 352 hp at 7,500 rpm, fed through a rear-mounted five-speed transaxle for balance. Pininfarina's Leonardo Fioravanti drew the sharp-edged body and Scaglietti built it in steel with aluminum opening panels. The press called it Daytona after Ferrari's 1-2-3 at the 1967 24 Hours; the factory never adopted the name officially. Autocar recorded 174 mph and 0-60 mph in 5.4 seconds, figures that stood as the magazine's fastest for years. 1,284 berlinettas are generally agreed; the GTS/4 spider is given as either 121 or 122, the right-hand-drive count as 149 to 158, and the competition cars as 15 to 24 depending on who is counting. Group 4 versions won their class at Le Mans three years running.",
 "history": "## Replacing the 275 GTB/4\n\nBy 1968 Ferrari's front-engined berlinetta was the 275 GTB/4, a 3.3-liter car of great charm that was being outrun by the mid-engined Lamborghini Miura. Ferrari's answer was not a mid-engined car but a larger and faster front-engined one, and the decision drew criticism at the time; Mel Nichols' period road test notes that the car was initially attacked for keeping the engine at the front. The 365 GTB/4 was shown at the Paris Salon in October 1968. Ferrari's own account describes it as the evolution of the 275 GTB/4, with the Colombo V12 enlarged from 3.3 to 4.4 liters, six Weber twin-choke 1.57 in (40 mm) carburetors and the rear transaxle retained for weight distribution. At 174 mph it was, in Ferrari's words, by some margin the fastest road Ferrari to that date.\n\n## Fioravanti, Pininfarina and Scaglietti\n\nThe body was drawn at Pininfarina by Leonardo Fioravanti, who would go on to the Dino, the 365 GT4 BB, the 308 and the 288 GTO and who has called the Daytona his favorite. Supercars.net quotes him saying he worked seven days without a break on the design. The shape abandoned the rounded forms of the 250 and 275 series for a sharp-edged wedge with a deep indentation line along the flanks and, on the first cars, four headlamps behind a full-width Perspex panel. Scaglietti built the bodies in Modena in steel over a Tipo 605 tubular frame, with aluminum doors, hood and trunk lid and a glassfiber inner tub on the berlinetta. The name came from outside: the press attached 'Daytona' after the 1967 24 Hours 1-2-3, and Ferrari used the name sparingly and always noted it was unofficial.\n\n## Engine, Transaxle and the Numbers\n\nThe Tipo 251 engine displaced 4,390 cc from an 3.2 in (81 mm) bore and 71 mm stroke, with twin camshafts per bank, two valves per cylinder, dry-sump lubrication and a 9.3:1 compression ratio. Ferrari claimed 352 hp at 7,500 rpm and 318 lb-ft at 5,500 rpm. Drive went through a torque tube to a five-speed transaxle with limited-slip differential. Motor Sport records that Autocar timed 0-60 mph in 5.4 seconds and reached 174 mph, figures that remained the magazine's road-test record for some time; Nichols' own test returned 5.5 seconds to 60 and a little over 12 seconds to 100 mph. The car was heavy and physical. Petrolicious describes steering that is heavy at low speeds and a rear end that breaks away suddenly on its narrow tires in the wet, and Nichols accepted the effort at the wheel and pedals as part of the car.\n\n## Spider, US Rules and Running Changes\n\nThe 365 GTS/4 spider was shown at Frankfurt in 1969, identical from the waist down but with steel floors, smaller twin tanks and a folding roof; Ferrari says it accounted for about ten per cent of sales. United States lighting regulations killed the Perspex nose, and pop-up headlamps were phased in between chassis 13800 and 14200 during 1971, with the satin aluminum nose band giving way to body color late that year. US cars ran 8.8:1 compression, a central muffler and electronic ignition, and from chassis 15701 the aluminum doors became steel so that side-impact bars could be fitted. Production ended in late 1973, by which time the 365 GT4 BB had taken over as the flagship.\n\n## Competition and the Cannonball\n\nFerrari built Group 4 versions in three series of five between 1971 and 1973, with lightened steel or aluminum bodies and engines tuned to between roughly 400 and 450 hp; Ferrari's own page counts 18 race-prepared berlinettas run by NART, Pozzi, Filipinetti, Swaters and Hoare. They took the GT class at Le Mans in 1972, 1973 and 1974, filling the first five class places in 1972, and a Daytona finished second overall and first in class at the 1979 Daytona 24 Hours, six years after production ended. On the road, Dan Gurney and Brock Yates drove chassis 14271 across America in the first Cannonball Baker run in November 1971, covering 2,876 miles in 35 hours 54 minutes at an average of 80.1 mph; Gurney later said they never exceeded 175 mph.",
 "marketNotes": "As of September 2026 classic.com's market benchmark for the 365 GTB/4 berlinetta stands at $641,683 on a downward trend, with an average recorded sale of $647,121 and a low of $309,350 for a 1973 car in September 2025. Recent tracked results include $865,000 for a 1971 car in August 2026, $792,000 for a 1972 car at Mecum in January 2026, $610,000 at Gooding Christie's in August 2026 and $500,000 for a 1973 car in January 2026, with five cars then listed between 640,000 euros and $799,890. The GTS/4 spider sits in a different bracket: as of September 2026 classic.com's benchmark is $2,699,633, also trending down, with a low of $2,200,000 in August 2025, and RM Sotheby's sold chassis 14901 for $2,315,000 including premium at Monterey in August 2026. The Competizione market is separate again: Gooding Christie's sold Series III chassis 16407 for $8,145,000 at Pebble Beach in August 2025, a record for the model. Premiums attach to Plexiglas-nose cars in some markets, to documented low mileage, to original colors and to Ferrari Classiche certification; right-hand drive, color changes, US specification and outside spider conversions sit below benchmark.",
 "whatToLookFor": "Documentation and originality carry the price. Ferrari Classiche certification confirms matching engine, transaxle and body numbers, and RM Sotheby's catalog entries lean on it heavily; the Monaco 2026 car had been certified in April that year. Establish the original color, since many cars have been changed, and note that a car titled as 1973 may have been built in 1972. Confirm which specification the car actually is: Perspex nose or pop-up lamps, European or US compression and exhaust, aluminum or steel doors, kilometer or mile instruments. Petrolicious warns against paying a premium for a 'rare Tipo A' claim, which simply means European pop-up cars, and against any dealer suggestion that Scaglietti built spiders beyond the factory run. Corrosion is the structural question. The steel is prone to rust around the rear wheel arches, the area between the quarter-light vent and the arch, lower door skins on steel-door US cars and, in bad cases, the chassis outriggers under the floor. Tom Yang's guide recommends demanding answers for any gap in the last ten to fifteen years of history, a compression test before purchase and a check that second-gear synchromesh works without noise. A complete original tool kit is worth a five-figure sum on its own. Take an extended drive from cold, because the engine takes a long time to come up to temperature and cold-stuck piston rings on a car that has sat will show themselves. Outside spider conversions, however well done, are berlinettas in the eyes of the market.",
 ...
 "valueTrajectory": "The Daytona listed at $19,500 in 1968. The market then fell with everything else and rebuilt slowly through the 1990s and 2000s. The 2013-2016 run took good berlinettas to $825,000, the price Gooding realized for a 12,000-mile 1972 car at Pebble Beach in 2016. As of September 2026 classic.com's berlinetta benchmark of $641,683 is trending down, with recent sales spread from $500,000 to $865,000, which reads as a market that has softened from its peak and is now stratifying by originality rather than rising across the board. Spiders have held better, with a benchmark of $2,699,633 as of September 2026, and the Competizione record of $8,145,000 in August 2025 shows the racing cars have decoupled from the road cars entirely.",
 ...
 "sources": [
  {
   ...
   "reliability": "high",
   "notes": "Ferrari's model page: describes the car as the evolution of the 275 GTB4, 4.4-liter V12 with six Weber twin-choke 40 mm carburetors, rear transaxle for weight distribution, and confirms 'Daytona' is an unofficial name. Page carries no production figure or specification table."
  },
  {
   "ref": "ferrari-365gts4",
  ...
  },
  {
   ...
   "sourceType": "manufacturer",
   "reliability": "high",
   "notes": "States '18 berlinetta versions were race-prepared and used by the Chinetti-NART, Pozzi, Filipinetti, Swaters, and Hoare teams'; aluminum coachwork on some, lightened steel on others; tuned engines and track suspension. Used for the competition-car count conflict."
  },
  {
   ...
   "sourceType": "manufacturer",
   "reliability": "high",
   "notes": "Ferrari editorial: October Paris Motor Show launch, Fioravanti as Pininfarina chief designer and his statement that the Daytona is his favorite, Colombo V12 enlarged from 3.3 to 4.4 liters, 352 hp, 174 mph 'by some margin the fastest road Ferrari up to that time', Le Mans class wins 1972-1974, 1979 Daytona second overall."
  },
  {
   ...
   "reliability": "medium",
   "notes": "Aggregated reference: 1,284 GTB/4 and 122 GTS/4, 1,406 total including 156 UK RHD coupes, 7 RHD spiders and 15 competition cars; 4,390 cc, 81 x 71 mm, 9.3:1 (8.8:1 US), 347 hp at 7,500 rpm, 318 lb-ft at 5,500 rpm; 174 mph, 0-60 in 5.4 s; name from the 1967 Daytona 1-2-3; Le Mans results; Cannonball 1971 figures."
  },
  {
   ...
   "reliability": "medium",
   "notes": "Specialist reference: 1,284 production GTB/4s (149 RHD), 121 production spiders (7 RHD), five prototypes, around 400 Plexiglas-nose cars, Tipo 605 chassis with glassfiber tub, 2,822 lb standard and 3,472 lb US, 0-62 in 5.7 s, 174 mph, pop-up lamps phased in between chassis 13800 and 14200, steel doors from chassis 15701, 128-liter and 98-liter tanks, Cannonball chassis 14271, alloy-bodied 12547 and 12653."
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "Specification sheet: 1,284 built, 1968 Paris debut, 353 hp at 7,500 rpm and 319 lb-ft at 5,000 rpm, gear ratios 3.075/2.120/1.572/1.250/0.964 with 3.300 final drive, 3,600 lb curb weight, 4,425 x 1,760 x 1,245 mm, $19,500 base price, Fioravanti quote about seven days without a break, ~120 spiders."
  },
  {
   "ref": "classic-gtb4",
  ...
  },
  {
   ...
   "reliability": "high",
   "notes": "Sold 545,000 euros, Monaco 2026. Chassis 16351, matching-numbers engine and gearbox, Ferrari Classiche certified April 2026, originally Marrone over beige, now red, Italian delivery via Crepaldi, titled as 1973. Catalog credits Fioravanti at Pininfarina with execution by Scaglietti."
  },
  {
   "ref": "rm-mo26-spider",
   ...
   "sourceType": "auction-house",
   "reliability": "high",
   "notes": "Sold $2,315,000, Monterey August 2026. Chassis 14901 described as 'the 37th of 121 Daytona Spiders produced', Nocciola Metallizzato over Nero, US instruments, factory air conditioning; catalog gives Frankfurt 1969 debut and 352 hp. Used for the 121 versus 122 spider conflict."
  },
  {
   "ref": "rm-lf25-16331",
  ...
  },
  {
   ...
   "reliability": "medium",
   "notes": "Buying guide: approximately 1,300 standard cars, 158 RHD, 121 spiders, 15 Competizione plus one aluminum NART car; $19,500 launch price; 500,000 to 700,000 pounds as of September 2020; Autocar 0-60 in 5.4 s and 174 mph as a long-standing magazine record; pop-up lamps from 1971; aluminum doors, hood and trunk lid."
  },
  {
  ...
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "Independent specialist guide (2005 costs): text gives 1,284 GTB/4s plus 19 competition berlinettas and 122 spiders, while its specification table lists 1,383 GTB/4s; timing chain tensioning damage; second-gear synchro and cracked transaxle casings, synchro overhaul $3,000-3,500; warped carburetors; fuel hose degradation; resonator rusting through; rust at lower door skins, quarter-vent area and outriggers; engine overhaul $25,000-30,000; spider conversions carry no premium; pre-purchase checklist."
  },
  {
   "ref": "dkeng-1973",
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "Specialist archive listing: 1,284 GTB/4 built, '158 of which were right-hand drive and came to the UK', October 1968 Paris launch, retractable headlamps from early 1971, production ending late 1973, 352 hp at 7,500 rpm, color change from Blu Dino to Giallo on this car."
  }
 ],
 "claims": [
  {
   "section": "history",
   "claimText": "The 365 GTB/4 was introduced at the Paris Salon in October 1968 as the replacement for the 275 GTB/4, with the Colombo V12 enlarged from 3.3 to 4.4 liters, and Ferrari describes it as by some margin the fastest road Ferrari to that date.",
   "confidence": "high",
   "status": "verified",
  ...
  {
   "section": "specs",
   "claimText": "The Tipo 251 engine is a 4,390 cc 60-degree all-alloy V12 with an 3.2 in (81 mm) bore and 71 mm stroke, twin overhead camshafts per bank, two valves per cylinder, dry-sump lubrication, six Weber 40 DCN twin-choke carburetors and a 9.3:1 compression ratio, with a factory claim of 352 hp at 7,500 rpm and 318 lb-ft at 5,500 rpm.",
   "confidence": "high",
   "status": "verified",
  ...
  {
   "section": "specs",
   "claimText": "The car uses a Tipo 605 tubular steel chassis on a 94.5 in (2,400 mm) wheelbase with a rear-mounted five-speed transaxle, independent wishbone suspension all round and Girling ventilated disc brakes; the berlinetta has a glassfiber inner tub and floors while the spider uses steel floors.",
   "confidence": "high",
   "status": "verified",
  ...
  {
   "section": "specs",
   "claimText": "Published weights for the Daytona vary widely, from 2,822 lb to 3,600 lb, and no single figure can be treated as authoritative.",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": ["supercarnostalgia-daytona", "supercars-net-daytona", "drive-nichols-test"],
   "conflictNote": "Supercar Nostalgia gives 2,822 lb for the standard car and 3,472 lb for US cars. Mel Nichols' period test gives 3,500 lb dry. Supercars.net gives 3,600 lb curb. The sources do not state a common basis (dry versus curb, European versus US) and the spread is not resolved by any source consulted."
  },
  {
   "section": "production",
  ...
  },
  {
   ...
   "conflictNote": "Supercar Nostalgia states 149 RHD berlinettas. Wikipedia states 156 UK right-hand-drive coupes. RM Sotheby's London 2025 catalog, Motor Sport and DK Engineering all state 158. Not resolved by any source consulted."
  },
  {
   "section": "production",
   ...
   "conflictNote": "Gooding Christie's, Wikipedia and Motor Sport state 15 official competition cars. RM Sotheby's states 24 completed of which 15 were officially recognized factory builds in three series of five. Ferrari's own Competizione page states 18 berlinettas were race-prepared. Tom Yang's guide states 19 competition variants. Not resolved by any source consulted."
  },
  {
   "section": "history",
   "claimText": "Pop-up headlamps replaced the original Plexiglas nose to meet US lighting regulations, phased in between chassis 13800 and 14200 during 1971, and from chassis 15701 the aluminum doors were replaced by steel so that side-impact bars could be fitted; US cars ran 8.8:1 compression with a central muffler and electronic ignition.",
   "confidence": "medium",
   "status": "verified",
  ...
  {
   "section": "history",
   "claimText": "Competition Daytonas won the GT class at Le Mans in 1972, 1973 and 1974, taking the first five class places in 1972, and a Daytona finished second overall and first in class at the 1979 Daytona 24 Hours; Series III cars were quoted at 450 hp at 8,500 rpm.",
   "confidence": "high",
   "status": "verified",
  ...
  {
   "section": "problems",
   "claimText": "Timing chain tensioning, second-gear synchromesh wear, warped Weber carburetors, degraded fuel hose and a rear resonator that rusts through are the recurring mechanical faults, with a synchro overhaul quoted at $3,000 to $3,500 and an engine overhaul at $25,000 to $30,000 in 2005 and up to $50,000 more recently.",
   "confidence": "medium",
   "status": "verified",
