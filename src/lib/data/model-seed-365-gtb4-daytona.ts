 ...
 "sources": [
  {
   ...
   "reliability": "high",
   "notes": "Ferrari's model page: describes the car as the evolution of the 275 GTB4, 4.4-liter V12 with six Weber twin-choke 40 mm carburettors, rear transaxle for weight distribution, and confirms 'Daytona' is an unofficial name. Page carries no production figure or specification table."
  },
  {
   "ref": "ferrari-365gts4",
