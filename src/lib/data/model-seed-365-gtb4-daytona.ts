...
export const seed365Gtb4Daytona = {
 ...
 "engines": [
  "4,390 cc Tipo 251 60-degree V12, all-alloy, twin overhead camshafts per bank, two valves per cylinder, six Weber 40 DCN 20/21 twin-choke carburettors, dry sump, 9.3:1 compression, 352 hp at 7,500 rpm and 318 lb-ft at 5,500 rpm (European specification, factory claim)",
  "4,390 cc Tipo 251 V12 to US specification: 8.8:1 compression, Weber 40 DCN 21A carburettors, revised exhaust with central muffler and electronic ignition; output not separately quoted by the sources consulted",
 ...
 "claims": [
  ...
  {
   "section": "specs",
   "claimText": "The Tipo 251 engine is a 4,390 cc 60-degree all-alloy V12 with an 81 mm bore and 71 mm stroke, twin overhead camshafts per bank, two valves per cylinder, dry-sump lubrication, six Weber 40 DCN twin-choke carburettors and a 9.3:1 compression ratio, with a factory claim of 352 hp at 7,500 rpm and 318 lb-ft at 5,500 rpm.",
   "confidence": "high",
   "status": "verified",
  ...
  {
   "section": "specs",
   "claimText": "The car uses a Tipo 605 tubular steel chassis on a 2,400 mm wheelbase with a rear-mounted five-speed transaxle, independent wishbone suspension all round and Girling ventilated disc brakes; the berlinetta has a glassfiber inner tub and floors while the spider uses steel floors.",
   "confidence": "high",
   "status": "verified",
