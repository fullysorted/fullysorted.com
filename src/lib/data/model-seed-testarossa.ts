...
export const seedTestarossa = {
 ...
 "notableTrims": [
  {
   ...
   "note": "The launch specification: one high-mounted driver's-side mirror at the top of the A-pillar, the result of a misread European rearward-visibility rule, and magnesium five-spoke wheels on a single center nut with 16.3 in (415 mm) Michelin TRX tires. The cars collectors chase, and the tires are why they are awkward to run."
  },
  {
  ...
  },
  {
   ...
   "note": "Catalysed, KE-Jetronic, 380 hp at 5,750 rpm rather than 390 at 6,300, with square side repeaters, larger bumpers, a third brake light from 1986 and, from 1987, a motorized belt up the A-pillar. US dry weight 3,660 lb against 3,320 lb."
  },
  {
  ...
  },
  {
   ...
   "note": "Not a facelift. Engine and gearbox dropped 1.18 in (30 mm), compression raised to 10:1, Motronic M2.7 and new plenums for 428 hp at 6,750 rpm, with reworked shift, brakes and interior."
  },
  {
 ...
 "specs": {
  ...
  "chassis": "Tipo F110 AB tubular steel frame with removable rear subframe; steel cabin and doors, aluminum panels, 100.4 in (2,550 mm) wheelbase",
  ...
  "brakes": "Ventilated discs, 12.4 in (315 mm) front and 12.2 in (310 mm) rear",
  "wheels_tires": "Single center-nut magnesium five-spoke on 16.3 in (415 mm) Michelin TRX to March 1986, then 8J and 10J x 16 in; five-stud OZ or Speedline from June 1988",
 ...
 "whatToLookFor": "Establish the specification first, because the market prices it precisely. The engine type stamped on the block distinguishes the European F113 A and F113 B from the US-Japanese F113 A 040 and the Swiss-Swedish 046 variants, and it does not always match what a listing claims. A genuine single-mirror car should have a chassis number below 67079 for a European example or 67487 for a US one; twin mirrors on an early chassis are retrofits, not factory. Single-nut wheels ran to 75997, and the five-stud change brought different suspension, dampers, brakes and column, so a mismatch between wheel type and chassis number means someone has been busy. Cars on original 16.3 in (415 mm) TRX tires need those tires, and they are expensive and hard to find. Then the paperwork. Cam-belt dates matter more than mileage here, and the interval is contested, so a documented history without gaps beats a single recent invoice. Because the belt job requires the engine and rear subframe to come out, that visit is when a competent shop deals with the water pump seals, clutch and coolant hoses; belts alone on a high-hours car is a partial job. Check every instrument, look hard at seat bolsters and the dash top, and treat long storage as a cost, not a virtue.",
 "commonProblems": "The flat-12 is described by specialists as strong; the recurring costs are the systems around it. Water pumps are the classic nuisance: FerrariChat contributors report the original pump weeping oil past a rear seal meant to hold back splash rather than pressurized oil, with a drain hole between the two seals as the tell, and the settled advice is to deal with it while the engine is out. Petrolicious notes that pre-1989 pumps can fail prematurely and that factory updates exist. Air-conditioning rubber deteriorates with disuse, and the system was never strong. Infrequent use also leaves dried fuel residue in the K-Jetronic or KE-Jetronic metering, which needs a Bosch specialist rather than a Ferrari one. The gearbox baulks when cold, second gear in particular, which is normal rather than a fault, but Petrolicious puts clutch life at around 15,000 miles and the clutch is another engine-out job. Electrics are the weak area, with period immobilisers unreliable and dash switchgear aging badly, and a new dash top is a four-figure item.",
 ...
 "claims": [
  ...
  {
   "section": "history",
   "claimText": "The Testarossa was conceived to correct two defects of the 512 BBi - a cabin overheated by coolant plumbing running from a front radiator, and negligible luggage space - by moving the radiators to the flanks and enlarging the car to 77.8 in (1,976 mm) wide on a 100.4 in (2,550 mm) wheelbase.",
   "confidence": "high",
   "status": "verified",
  ...
  {
   "section": "problems",
   "claimText": "Water pump seals are the recurring Testarossa fault: the pump weeps oil past a rear seal designed to hold back splash rather than pressurized oil, the drain hole between the twin seals is the tell, and the settled advice is to address it during the engine-out belt service. Pre-1989 pumps are also reported to fail prematurely, with factory updates available.",
   "confidence": "medium",
   "status": "verified",
  ...
  {
   "section": "summary",
   "claimText": "Period testing found the Testarossa unusually civilized for its class - a silky rather than heavy clutch, crisp steering above 20 mph, good over-the-shoulder visibility - while criticizing a wandery feel under light braking, the single high mirror obstructing junctions, and instruments that were hard to read.",
   "confidence": "medium",
   "status": "verified",
