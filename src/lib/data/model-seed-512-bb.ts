...
export const seed512Bb = {
 ...
 "productionNotes": "The two halves of this run are not equally settled. For the fuel-injected 512 BBi every source consulted gives 1,007 cars built between 1981 and 1984: Wikipedia, the Classic Trader and Maserati-Net buying guides, Supercar Nostalgia, classic.com and two separate RM Sotheby's catalogue entries. Supercar Nostalgia adds that 43 of those were right-hand drive. For the carbureted 512 BB, Ferrari's own model page states 929 cars, with a chassis range of 19677 to 38487, and that figure is repeated by Wikipedia, both buying guides, supercars.net and Moto Gallery, while Hagerty rounds it to 'just over 900'. Octane, however, describes a right-hand-drive 1977 car as 'one of only 927 BBs produced'. The two-car difference is small and may be a transcription error, but Octane is a credible title and no source consulted explains the discrepancy, so it is recorded here rather than smoothed over and no combined total is asserted: the sum is either 1,936 or 1,934. A secondary divergence concerns chassis numbering: Moto Gallery, a low-reliability blog, gives a 512 BB range of 19781 (prototype) to 34347, which does not match Ferrari's published 19677 to 38487. Ferrari's figure is preferred but the disagreement is noted. For context, the preceding 365 GT4 BB is stated at 387 cars (Wikipedia, Maserati-Net), of which 88 were right-hand drive, and the whole Boxer family at 2,323 cars (Wikipedia, Drive). Bodies were built by Scaglietti with final assembly at Maranello. The competition 512 BB/LM is counted separately: three Series 1 cars in 1978 and 25 Series 2 cars in two sub-series to 1982, a total of 25 for the second series that RM Sotheby's catalogues repeat. None of the road cars was built to US specification; every North American example passed through a gray-market federalization shop.",
 "notableTrims": [
  {
