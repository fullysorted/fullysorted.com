...
export const seed512Bb = {
 ...
 "claims": [
  ...
  {
   "section": "specs",
   "claimText": "The 512 BB engine is a 4,943 cc all-alloy flat-12 of 82 by 78 mm at 9.2:1 compression, with twin overhead camshafts per bank, two valves per cylinder, four triple-choke Weber 40 IF 3C carburettors and a dry sump, driving through a five-speed transaxle mounted beneath the crankcase.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "ferrari-512-bb",
  ...
  {
   "section": "production",
   "claimText": "Production of the carburetted 512 BB is stated as 929 cars by Ferrari, with chassis numbers 19677 to 38487, and repeated by most secondary sources, but Octane states 927; the fuel-injected 512 BBi is stated as 1,007 cars by every source consulted. No combined total is asserted.",
   "confidence": "medium",
   "status": "disputed",
   "sourceRefs": [
    "ferrari-512-bb",
