...
export const seedBarracudaEBody = {
 ...
 "engines": [
  "3,245 cc (198 cu in) slant six, 125 hp SAE gross (1970-1971)",
  "3,687 cc (225 cu in) slant six, 145 hp SAE gross (1970-1971); 100 hp SAE net (1972)",
  "5,211 cc (318 cu in) LA V8, 230 hp SAE gross (1970-1971); 150 hp SAE net (1972-1974)",
  "5,572 cc (340 cu in) LA V8 four-barrel, 275 hp SAE gross (1970-1971); 240 hp SAE net (1972-1973)",
  "5,572 cc (340 cu in) Six Barrel V8, three Holley two-barrels on an aluminum manifold, block webbed for four-bolt mains, 290 hp SAE gross - AAR 'Cuda only, 1970",
  "6,276 cc (383 cu in) B V8, quoted between 275 and 335 hp SAE gross by year and source (1970-1971)",
  "7,210 cc (440 cu in) RB V8, four-barrel, 375 hp SAE gross (1970), 370 hp special order (1971)",
  "7,210 cc (440 cu in) Six Barrel RB V8, 390 hp SAE gross (1970), 385 hp (1971)",
  "6,981 cc (426 cu in) Street Hemi V8, twin Carter AFB four-barrels, 10.25:1, 425 hp SAE gross at 5,000 rpm, 490 lb-ft at 4,000 rpm (1970-1971)",
  "5,899 cc (360 cu in) LA V8, 245 hp SAE net at 4,000 rpm, 320 lb-ft at 3,600 rpm (1974)"
 ],
 ...
 "notableTrims": [
  ...
  {
   "name": "AAR 'Cuda",
   "note": "1970 only, homologating Plymouth's Trans-Am entry: 340 Six Barrel, glassfiber hood, side-exit exhaust ahead of the rear wheels, spoilers front and rear, strobe stripe, $3,966 new."
  },
  {
   "name": "Hemi 'Cuda",
  ...
  },
  {
   ...
   "note": "Three two-barrels on the 440, 390 hp SAE gross in 1970 and 385 in 1971. Quicker in a straight line than many Hemi cars and much cheaper to keep."
  },
  {
   "name": "'Cuda 360 (1974)",
   "note": "The last performance 'Cuda, the 360 at 245 hp SAE net standard. Long ignored, which is why unmolested and documented cars survive more often than the 1970-71 ones do."
  }
 ],
 "specs": {
  ...
  "power": "125 to 425 hp SAE gross across the 1970-71 range, the 426 Hemi quoted at 425 hp at 5,000 rpm; by 1974, 150 hp SAE net (318) and 245 hp SAE net at 4,000 rpm (360)",
  ...
  "weight": "3,630 lb curb for a 1970 'Cuda 340 weighed by Car Life, 56/44 front to rear; big-block cars are heavier",
 ...
 "sources": [
  ...
  },
  {
   ...
   "sourceType": "journalism",
   "reliability": "medium",
   "notes": "Period Car Life test of a 1970 'Cuda 340 reprinted in full: 0-60 in 7.5 s, quarter 15.0 s at 94 mph, 125.4 mph, 3,630 lb curb, 56/44 distribution, over-servoed power drums, terminal understeer, camber-related tire wear and doors about 75 lb heavier each."
  },
  {
   ...
   "sourceType": "specialist",
   "reliability": "medium",
   "notes": "1970 Hemi 'Cuda at 652 built including 14 convertibles, 284 four-speeds; twin Carter AFB four-barrels, 10.25:1, 425 hp at 5,000 rpm and 490 lb-ft at 4,000 rpm; Motor Trend May 1970 at 5.8 s to 60 and 14.0 s at 102 mph; names Chrysler Registry and Galen Govier reports as the verification tools."
  },
  {
  ...
  },
  {
   ...
   "sourceType": "auction-house",
   "reliability": "high",
   "notes": "Lot record for a car cataloged explicitly as a Hemi 'Cuda clone, sold for $48,600, establishing the documentation gap between a cataloged clone and a documented Hemi 'Cuda coupe."
  },
  {
 ...
 "claims": [
  ...
  {
   "section": "specs",
   "claimText": "The 1970-1971 range ran from a 198 cu in slant six through 318, 340, 383 and 440 V8s to the 426 Street Hemi, quoted at 425 hp SAE gross at 5,000 rpm and 490 lb-ft at 4,000 rpm on twin Carter AFB four-barrels and 10.25:1 compression, and costing $871.45 as an option in 1970 and $884 in 1971.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "overdrive-1970-facts",
  ...
  {
   "section": "history",
   "claimText": "The AAR 'Cuda homologated Plymouth's Trans-Am entry with a 340 carrying three Holley two-barrels on an aluminum manifold and a block webbed for four-bolt mains at 290 hp, a glassfiber cold-air hood, chrome exhaust trumpets ahead of the rear wheels, spoilers, staggered tires and a strobe stripe, at $3,966 new; the racing engines were de-stroked to 303.8 cu in and Dan Gurney's All American Racers took three poles, a best finish of second and no wins.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "oldcars-aar",
  ...
  {
   "section": "market",
   "claimText": "Auction evidence for the 1971 Hemi 'Cuda convertible runs from $2,420,000 at RM Sotheby's Arizona in 2007 for chassis BS27R1B269588, through a $3.5 million Mecum sale in 2014 and a $4.8 million unmet bid at Mecum Indianapolis in May 2021 against a reserve reported at up to $6.5 million, to $3.3 million with the ten per cent buyer's premium at Mecum Kissimmee on 17 January 2026. Documentation rather than condition sets that top: RM Sotheby's catalogs Hemi 'Cuda clones as clones, one 1970 example selling for $48,600 against a coupe benchmark of $288,247 as of August 2026.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "rm-az07-hemi-vert",
  ...
  {
   "section": "problems",
   "claimText": "The recurring faults are rust in the sills, floors, rear quarters, screen aperture, rear pillars and lower door skins; overheating, particularly on big-block cars; torsion-bar degradation announced by creaking on full lock; substituted Six Barrel carburetors; and front drums inadequate behind the larger engines. Three federal recall campaigns cover the 1971 car: 71V004000 on a brake shoe anchor pin, 71V067000 on disc rotors and 71V117000 on a power steering hose.",
   "confidence": "high",
   "status": "verified",
   "sourceRefs": [
    "tradeuniquecars-cuda",
