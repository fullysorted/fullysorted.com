    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-12">
        {[
          ...
          { Icon: Sparkles, color: 'text-gold', title: 'Enquiries come straight to you', body: 'An owner who picks you emails you — we do not fan your enquiry out to four competitors.' },
